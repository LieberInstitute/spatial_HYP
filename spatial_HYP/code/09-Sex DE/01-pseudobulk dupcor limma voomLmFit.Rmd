...
## re run with a hardcoded fix that should only change results for k=15 nnsvg10 ARC.2 (X6) on 10/27/25. -- separate script
```{r}
...
fwrite(bsHna60sOut2[["BSpace_k15_HARMONYlmbna_nnsvg10"]],"spatial_HYP/processed-data/09-Sex DE/01b-voomLmFit_nnsvg10-HmnylmbNA-BS-15-singleClusts.txt",sep="\t",quote=F)
fwrite(bsHna60sOut2[["BSpace_k15_HARMONYlmbna_hvg20_clpsdARC_clpsdVMH"]],"spatial_HYP/processed-data/09-Sex DE/01c-voomLmFit_nnsvg10-HmnylmbNA-BS-15-VMHARCclpsd.txt")


## save RDS of pseudobulk expression values for plotting aggregate results
saveRDS(bsHna60sOutE,"spatial_HYP/processed-data/09-Sex De/01d-pseudobulkExpr_01-voomLmFit_svg10-svg20-hvg20_Hmnydflt-mnn30-HmnylmbNA_BS-15-20-31-15VMHARCclpsd.RDS")
