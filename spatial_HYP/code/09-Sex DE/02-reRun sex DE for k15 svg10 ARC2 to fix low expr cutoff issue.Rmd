...
fwrite(v.swt.e.tt,"processed-data/09-Sex DE/02-k15_svg10_ARC.2_sexDE_correctedRun_102725.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
...
sexderds <- readRDS("processed-data/09-Sex DE/01-voomLmFit_svg10-svg20-hvg20_Hmnydflt-mnn30-HmnylmbNA_BS-15-20-31-15VMHARCclpsd.RDS")
...
saveRDS(sexderds,"processed-data/09-Sex DE/01-voomLmFit_svg10-svg20-hvg20_Hmnydflt-mnn30-HmnylmbNA_BS-15-20-31-15VMHARCclpsd_k15ARC2fixed.RDS")
### 


sexdetab <- fread("processed-data/09-Sex DE/01b-voomLmFit_nnsvg10-HmnylmbNA-BS-15-singleClusts.txt")

sexdetab <- sexdetab[assay!="X6"]
v.swt.e.tt[,chromosome_name:=NULL]
sexdetab <- rbind(sexdetab,v.swt.e.tt)

fwrite(sexdetab,"processed-data/09-Sex DE/01b-voomLmFit_nnsvg10-HmnylmbNA-BS-15-singleClusts_ARC2fixed.txt",sep='\t',quote=F,row.names=F,col.names=T)
```
seshinf
```{r}
sessionInfo()
