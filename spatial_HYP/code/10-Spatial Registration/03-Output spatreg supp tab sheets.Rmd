...
for (i in c(1:length(scc))){
   ...
   if (i %in% c(1,4)){
      setnames(outtab,"X13","ARC.ventral")
   } else if (i==2){ 
      setnames(outtab,"X11","ARC20.ventral1")
      setnames(outtab,"X12","ARC20.ventral2")
   } else {
      setnames(outtab,"X17","ARC31.ventral1")
      setnames(outtab,"X24","ARC31ventral2") 
   }
