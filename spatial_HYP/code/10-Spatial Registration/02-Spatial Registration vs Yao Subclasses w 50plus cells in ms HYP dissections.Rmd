...
## this block only: list output naming bugfix 11-10-24
...
```{r}
outfilesuff <- paste0(names(abas),"_to_",names(hyps))

spatregs <- mcmapply(m=hyps,s=abas,z=outfilesuff,USE.NAMES=FALSE,SIMPLIFY = F,mc.cores=8,FUN = function(m,s,z){
