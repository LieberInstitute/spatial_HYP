...
### LEFT OFF HERE -- CANNOT COMPLETE TESTS DUE TO TIMEOUTS ###

cocoqueryres <- list()
i<-1
for(i in c(1:length(markerqueries))){
    cocoqueryres[[i]] <- scCoco::findRegions_genesets(gene_set = markerqueries[[i]],min_ids = 50,target_structure_id=1097,timeout=1000)
