...
gc(full=T)
### collapse pathways-this part is WAY WAY slower than the GSEA itself, in part because it's single processor. not even run in the end.
# 
...
# saveRDS(sexderes2,"processed-data/11-GSEA/03b-Sex DE mSigDB_1,2,3,5,6,8 fGSEA-collapsePathways output.RDS") # intermediate file for saving progress. can be deleted after running next step:
# 
# 
# rm(sexdelist)
# gc(full=T)
...
gc(full=T)
### collapse pathways-this part is WAY WAY slower than the GSEA itself. doesnt even complete so not run.
# 
