---
title: "04.2-SexDE TFtarg GSEA with fixed k15 ARC2"
...
origsexmsig <- readRDS("processed-data/11-GSEA/04a-Sex DE TF-target GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd.RDS")
origsexmsig$BSpace_k15_HARMONYlmbna_nnsvg10_X6 <- sexderes$ARC.2
saveRDS(origsexmsig,"processed-data/11-GSEA/04a-Sex DE TF-target GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd_ARC15.2fixed.RDS")
rm(origsexmsig)
```
...
origunsign <- readRDS("processed-data/11-GSEA/04d-Unsigned Sex DE TF-target GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd.RDS")
origunsign$BSpace_k15_HARMONYlmbna_nnsvg10_X6 <- sexderes.unsign$ARC.2
saveRDS(origunsign,"processed-data/11-GSEA/04d-Unsigned Sex DE TF-target GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd_ARC15.2fixed.RDS")
