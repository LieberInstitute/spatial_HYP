...
```{r}
hg19g <- fread("raw-data/dcs04sharedStatsgenLDSCbase_gene_meta_hg19.txt")
...
for (n in names(allg)[3:ncol(allg)]){
    ...
    fwrite(tmp,paste0("code/15-sLDSC-seg/bedfiles/",n,".bed"),sep='\t',quote=F,row.names=F,col.names=F)
}
```
