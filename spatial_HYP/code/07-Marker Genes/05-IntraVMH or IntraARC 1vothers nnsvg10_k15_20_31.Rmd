...
## for the k31s, similar deal but we need to compare each cluster to the others in aggregate. (e.g., VMH31.1 vs VMH31.2-31.5 all put under the aegis of "otherVMH")
```{r}
i<-3
b <- copy(bscls.dt[["k31"]])
