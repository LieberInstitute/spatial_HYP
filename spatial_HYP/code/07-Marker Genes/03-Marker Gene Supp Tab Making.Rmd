...
setnames(slibdmk[[2]],gsub(names(slibdmk[[2]]),pattern="X11",replacement="ARC20.ventral1"))
setnames(slibdmk[[2]],gsub(names(slibdmk[[2]]),pattern="X12",replacement="ARC20.ventral2"))
...
setnames(slibdmk[[3]],gsub(names(slibdmk[[3]]),pattern="X17",replacement="ARC31.ventral1"))
setnames(slibdmk[[3]],gsub(names(slibdmk[[3]]),pattern="X24",replacement="ARC31ventral2"))
