...
## UPDATE 03/30/25: gprofiler seems to only map human ALDH1A1 (RALDH1) to mouse Aldh1a7, which ahs been demonstrated to NOT have retinoid metabolism activity, while its paralog Aldh1a1 does. So let's see if homologene does better.
...
pbxp <- pbxp[["BSpace_k15_HARMONYlmbna_nnsvg10_clpsdARC_clpsdVMH"]][assay %in% c("VMH","ARC")]
...
keepmsname <- c("assay","expr","ensg","mouseGene","symb.hg")
...
[1] colorout_1.3-0.2    UniProt.ws_2.46.1   RSQLite_2.3.9       BiocGenerics_0.52.0
[5] orthogene_1.12.0    data.table_1.17.0   rlang_1.1.5        
...
loaded via a namespace (and not attached):
 ...
 [46] withr_3.0.2               Biobase_2.66.0            treeio_1.30.0            
