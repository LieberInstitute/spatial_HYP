...
bs_clusts <- list.files("analysis/data/spe_053123/H02-clustering/03-bs_harmony_hvg1020_nnsvg1020_9-15-20-31_out/",pattern=".txt")
```
...
for (i in c(1:length(bs_clusts))) {
    curclusts <-
        fread(
            paste0(
                "analysis/data/spe_053123/H02-clustering/03-bs_harmony_hvg1020_nnsvg1020_9-15-20-31_out/",
                bs_clusts[i]
            )
        )
    ...
    pdf(
        paste0(
            "plots/spe_053123/H02-clustering/02-bayesspace_q9-15-20-31_HVGorSVG_spotplots/",
...
for (i in c(1:length(bs_clusts))) {
    ...
    pdf(
        paste0(
            "plots/spe_053123/H02-clustering/02-bayesspace_q9-15-20-31_HVGorSVG_harmonyPCA/",
            gsub(bs_clusts[i], pattern = "^(.*)\\.txt$", replacement = "\\1"),
            ".pdf"
        ),
        width = 10,
...
for (i in c(1:length(bs_clusts))) {
    ...
    curclusts <- fread(
        paste0("analysis/data/spe_053123/H02-clustering/03-bs_harmony_hvg1020_nnsvg1020_9-15-20-31_out/",
               bs_clusts[i]))
    ...
    pdf(paste0("plots/spe_053123/H02-clustering/02-bayesspace_q9-15-20-31_HVGorSVG_harmonyUMAP/",
            gsub(bs_clusts[i], pattern = "^(.*)\\.txt$", replacement = "\\1"),
            ".pdf"),
        width = 10,
        height = 8
