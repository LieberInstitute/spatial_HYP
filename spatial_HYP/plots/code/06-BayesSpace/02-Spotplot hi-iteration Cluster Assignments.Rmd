---
title: "02-Cluster Assignment Spotplots-60k iter BayesSpace runs"
...
for (i in c(1:length(bs_clusts))) {
    ...
    nclusts <- length(unique(curclusts[, 2]))
    colLabels(hyp2) <- factor(curclusts[, 2],levels=paste0("X",c(1:nclusts)))
    pal <- palette36.colors(n = nclusts)[c(3:(nclusts+2))]
    ...
    do.call("grid.arrange",list(arrangeGrob(grobs=plt,ncol=3,nrow=4),leg.tmp2,ncol=2,widths=c(18,2)))
    dev.off()
...
other attached packages:
 ...
 [3] Polychrome_1.5.1            spatialLIBD_1.16.2         
...
[13] ggplot2_3.5.1               Biostrings_2.72.1          
[15] GenomeInfoDb_1.40.1         XVector_0.44.0             
[17] IRanges_2.38.1              default_1.0.0              
[19] S4Vectors_0.42.1            BiocGenerics_0.50.0        
[21] colorout_1.3-0.2            data.table_1.15.4          
[23] rlang_1.1.4                
...
[130] memoise_2.0.1             bslib_0.7.0               benchmarkmeData_1.0.4    
[133] bit_4.0.5                
> sessioninfo::session_info()
─ Session info ──────────────────────────────────────────────────────────────────
 setting  value
