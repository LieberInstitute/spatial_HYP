...
saveRDS(mkres,"data/11-GSEA/01a-Marker msigdb_1,2,3,5,6,8 GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd.RDS")
...
saveRDS(mkres2,"data/11-GSEA/01b-Marker mSigDB_1,2,3,5,6,8 fGSEA-collapsePathways output.RDS")
...
saveRDS(mkres3,"data/11-GSEA/01c-Marker mSigDB_1,2,3,5,6,8 GSEA clpspath mainPathways-only.RDS")
# clean up
# rm(mkres,mkres2)
gc(full=T)
```
