...
## save an alternative version with cell types faceted
pdf("manuscript_plots/Fig2/2Ialt-ARC_celltypes_1225A_facet.pdf",height=3.75,width=3.75)
ggplot(pani[sdimy<6500],aes(x=sdimx,y=sdimy,color=banksyclus))+
    geom_point(size=0.075,stroke=0.375)+
    scale_color_manual(values=arcpal)+
...
## save an alternative version with cell types faceted
pdf("manuscript_plots/Fig2/2Jalt-VMH_celltypes_1225A_facet.pdf",height=3.75,width=3.75)
ggplot(panj[sdimy<6500],aes(x=sdimx,y=sdimy,color=banksyclus))+
    geom_point(size=0.075,stroke=0.375)+
    scale_color_manual(values=vmhpal)+
    facet_wrap(~banksyclus)+
