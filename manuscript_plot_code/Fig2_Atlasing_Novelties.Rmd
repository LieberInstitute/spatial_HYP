...
arcvmhanno[subclus_annot="VMH-Glia-Mixed",subclus_annot:="VMH-Glia Mix"]
...
arcvmhanno[subclus_annot=="POMC-Oligo-Mixed",subclus_annot:="*POMC*-Oligo Mix"]
arcvmhanno[subclus_annot=="Excit-SLC17A7-Glial-Mixed",subclus_annot:="*SLC17A7*-GGlia Mix"]
...
names(vmhpal) <- c("*SLC17A6*-*CRHR2*","VMH-Glia Mix","*FEZF1*-*LAMP5*-*NRGN*","*HCRT*-*SLC6A3*-*TAC1*")

arcpal <- c("#5dd959","#296656","#09979B","#A997AB","#D0B")
names(arcpal) <-  c("*AGRP*","*POMC*-Oligo Mix","*GAL*-*TRH*-*GHRH*","*SLC17A7*-Glia Mix","*TAC3*-*AR*-*ESR1*")
