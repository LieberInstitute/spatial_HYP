...
# substitute #D0B as the color for ESR1 cluster
...
pana <- pana[banksyclus %in% bkanno[subclus_domain=="VMH",bjm_annot]]
...
panb <- panb[banksyclus %in% bkanno[subclus_domain=="ARC",bjm_annot]]
