...
### for reference: already filtered to in-tissue, non-zero-count spots
```
...
### save as 3 page pdf
pdf("manuscript_plots/Supplemental/SF-RemovedSpots_Spotsweeper_and_Numerical_filt.pdf",width=8,height=10.5)
