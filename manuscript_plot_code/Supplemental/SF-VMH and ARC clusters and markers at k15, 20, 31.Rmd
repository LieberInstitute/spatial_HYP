...
intramk <- readRDS("spatial_HYP/processed-data/07-Marker_genes/05-IntraVMH-intraARC_1clus_vallother_clus_slibdEnrichment.RDS")

sampleplotnames <- fread("standardized_sampleids_for_plotting.txt")
```

## replace sample names for plotting
```{r}
...
bscls.dt[["k31"]][cl=="X7",cl:="WM1"]
bscls.dt[["k31"]][cl=="X15",cl:="WM2"]
bscls.dt[["k31"]][cl=="X23",cl:="WM3"]
...
globalmk2[["k15"]][clus=="X4",clus:="ARC1"]
globalmk2[["k15"]][clus=="X6",clus:="ARC2"]
globalmk2[["k15"]][clus=="X7",clus:="VMH1"]
globalmk2[["k15"]][clus=="X12",clus:="VMH2"]
globalmk2[["k15"]][clus=="X3",clus:="WM1"]
globalmk2[["k15"]][clus=="X10",clus:="WM2"]

globalmk2[["k20"]][clus=="X2",clus:="VMH20_1"]
globalmk2[["k20"]][clus=="X3",clus:="VMH20_2"]
globalmk2[["k20"]][clus=="X1",clus:="ARC20_1"]
globalmk2[["k20"]][clus=="X4",clus:="ARC20_2"]
globalmk2[["k20"]][clus=="X15",clus:="WM1"]
globalmk2[["k20"]][clus=="X17",clus:="WM2"]

# k31: x6 21 25 26 31 = VMH; 2,4,11,22 ARC
globalmk2[["k31"]][clus=="X6",clus:="VMH31_1"]
globalmk2[["k31"]][clus=="X21",clus:="VMH31_2"]
globalmk2[["k31"]][clus=="X25",clus:="VMH31_3"]
globalmk2[["k31"]][clus=="X26",clus:="VMH31_4"]
globalmk2[["k31"]][clus=="X31",clus:="VMH31_5"]
globalmk2[["k31"]][clus=="X2",clus:="ARC31_1"]
globalmk2[["k31"]][clus=="X4",clus:="ARC31_2"]
globalmk2[["k31"]][clus=="X11",clus:="ARC31_3"]
globalmk2[["k31"]][clus=="X22",clus:="ARC31_4"]
globalmk2[["k31"]][clus=="X7",clus:="WM1"]
globalmk2[["k31"]][clus=="X15",clus:="WM2"]
globalmk2[["k31"]][clus=="X23",clus:="WM3"]
...
globalmkxpr <- mapply(g=globalmkgn,b=bscls.dt,SIMPLIFY=FALSE,FUN=function(g,b){
    ...
    hyptmp$label <- factor(hyptmp$label,levels=c(arcs,vmhs,wms))
...
mapply(n=names(globalmkxpr),x=globalmkxpr,SIMPLIFY=FALSE,FUN=function(x,n){
    nclus <- length(unique(x[[1]]$label))
    
    pal <- Polychrome::createPalette(N=nclus+1,seedcolors="#02740F")[2:(nclus+1)]
    names(pal) <- unique(x[[1]]$label)
...
other attached packages:
 ...
 [3] viridisLite_0.4.2           circlize_0.4.16            
 [5] Cairo_1.6-2                 ggrastr_1.0.2              
 [7] scran_1.32.0                scuttle_1.14.0             
 [9] BiocParallel_1.38.0         parallelly_1.38.0          
[11] colorout_1.3-0.2            ComplexHeatmap_2.20.0      
...
loaded via a namespace (and not attached):
 ...
 [82] S4Arrays_1.4.1            scatterplot3d_0.3-44      pkgconfig_2.0.3          
 ...
 [94] knitr_1.48                rstudioapi_0.16.0         rjson_0.2.21             
 [97] curl_5.2.1                cachem_1.1.0              GlobalOptions_0.1.2      
[100] Polychrome_1.5.1          BiocVersion_3.19.1        vipor_0.4.7              
[103] AnnotationDbi_1.66.0      restfulr_0.0.15           pillar_1.9.0             
[106] vctrs_0.6.5               promises_1.3.0            BiocSingular_1.20.0      
[109] dbplyr_2.5.0              beachmat_2.20.0           cluster_2.1.6            
...
[124] ggbeeswarm_0.7.2          munsell_0.5.1             Biostrings_2.72.1        
[127] tiff_0.1-12               lazyeval_0.2.2            Matrix_1.7-0             
[130] ExperimentHub_2.12.0      benchmarkme_1.0.8         sparseMatrixStats_1.16.0 
[133] bit64_4.0.5               KEGGREST_1.44.1           statmod_1.5.0            
[136] shiny_1.8.1.1             AnnotationHub_3.12.0      gridtext_0.1.5           
[139] igraph_2.0.3              memoise_2.0.1             bslib_0.7.0              
