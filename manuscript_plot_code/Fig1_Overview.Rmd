...
## Panel E: Visium with key domains labeled
```{r}
pane <- hyp2[,hyp2$sample_id=="V12D05-350_C1"]

p <- make_escheR(pand)
p <- p |> add_fill("Visium Domain",size=0.25,point_size = 0.5)

pdf("manuscript_plots/Fig1/1E-V12D05_350_C1_keydomains.pdf",height=2,width=2)
p+
...
### Panel F: VMH marker in Visium sample (NR5A1)
