...
### Panel D is the xenium cluster UMAP, which we should re-generate here with matched palette components where possible.
```{r}
...
### set up the palette accordingly
xenpal <- c("#8c63cf","#5dd959" , "#F59B26", "#D193FE", "#551CFD" , "#FB479F","#A9A7A9","#00B3FD","#3D4047","#FF0DF7","#AD260D")
...
### Panel E: VMH marker in Visium sample (NR5A1)
...
pdf("manuscript_plots/Fig1/1E-V12D05_350_C1_NR5A1.pdf",height=2,width=2)
p+
...
# panels F is a representative ARC marker in our Visium sample : POMC
```{r}
...
pdf("manuscript_plots/Fig1/1F-V12D05_350_C1_POMC.pdf",height=2,width=2)
p+
    scale_color_manual(values=pal,na.value = NA)+
    scale_fill_continuous("log\ncounts",low= "#FFFFFF",high="#000000")+
    #scale_fill_grey()+
...
Panel G is Visium expression of a WM marker, KLK6. (Our options for those are somewhat limited on the xenium side).
```{r}
## for escheR, we put the assay value into the colData for it to use
...
pdf("manuscript_plots/Fig1/1G-V12D05_350_C1_KLK6.pdf",height=2,width=2)
p+
    scale_color_manual(values=pal,na.value = NA)+
    scale_fill_continuous("log\ncounts",low= "#FFFFFF",high="#000000")+
    #scale_fill_grey()+
...
Panel H is the xenium domains in the same donor (Br8741 , sample X99_8741C).

### Panel H: xenium counterpart to C (X99_8741C)
```{r}
...
pdf("manuscript_plots/Fig1/1H-X99_8741C_Xendomains.pdf",height=2,width=2)
p+
...
### finally, append the counts for our gene of interest (NR5A1) and make panel I
```{r}
...
pdf("manuscript_plots/Fig1/1I-X99_8741C_NR5A1.pdf",height=2,width=2)
p+
    scale_fill_continuous("log\ncounts",low= "#FFFFFF",high="#000000")+
...
pdf("manuscript_plots/Fig1/1J-X99_8741C_POMC.pdf",height=2,width=2)
p+
    scale_fill_continuous("log\ncounts",low= "#FFFFFF",high="#000000")+
    geom_path(data=dompoly,aes(x=xpol,y=ypol,group=dompol,col=dompol),linewidth = 0.25)+
    scale_color_manual(values=pal,na.value = NA)+
...
pdf("manuscript_plots/Fig1/1K-X99_8741C_KLK6.pdf",height=2,width=2)
p+
    scale_fill_continuous("log\ncounts",low= "#FFFFFF",high="#000000")+
    geom_path(data=dompoly,aes(x=xpol,y=ypol,group=dompol,col=dompol),linewidth = 0.25)+
    scale_color_manual(values=pal,na.value = NA)+
