...
### plots
pdf("manuscript_plots/Fig2/vVMH_MC4R_pbulks.pdf",height=1,width=0.6)
ggplot(vpb[gene_name=="MC4R"&domain=="VMH"],aes(x=Sex,y=value,col=domain,fill=Sex))+
  ...
  theme(axis.text.x=element_text(size=7),axis.text.y=element_blank(),axis.title.y=element_text(size=7),axis.title.x=element_blank(),panel.grid.major = element_line(linewidth=0.2),panel.grid.minor=element_line(linewidth=0.1),axis.ticks=element_line(linewidth=0.2,color = "#000000"))
dev.off()

pdf("manuscript_plots/Fig2/vARC_RDH10_pbulks.pdf",height=1,width=0.6)
