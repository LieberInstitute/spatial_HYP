...
visdeplt[assay=="ARC"&gene_name %in% c("SHANK3","DCC","CHRM5","KCNMB2","RDH10"),label:=gene_name]
...
# save
pdf("manuscript_plots/Fig3/3A-Visium Sex DE Volcano_ptsizeByP.pdf",height=2.5,width=2.3)
p
dev.off()
...
# save
pdf("manuscript_plots/Fig3/3Aalt-Visium VMH Sex DE Volcano_sizeByP.pdf",height=2,width=1.95)
p
dev.off()
```

## panel B: xenium equiv, VMH types in VMH domain
## set up cell type-color palettes for xenium plots
```{r}
...
# this is currently part of figure 4 instead.
...
# save
pdf("manuscript_plots/Fig3/3Balt-Xenium VMH domain, all cells considered together_sizeByP.pdf",height=2,width=1.95)
p
dev.off()
```
...
```{r}
visdeplt <- visde[assay=="ARC"][gene_name %in% c("SHANK3","DCC","CHRM5","KCNMB2","RDH10"),label:=gene_name]
...
# save
pdf("manuscript_plots/Fig3/3Calt-Visium ARC Sex DE Volcano_sizeByP.pdf",height=2,width=1.95)
p
dev.off()
```
...
## points to label
xendomdeplt <- xendomdeplt[gene_name %in% c("SHANK3","DCC","RDH10"),label:=gene_name]
...
pdf("manuscript_plots/Fig3/3Dalt-Xenium ARC domain, all cells considered together_sizeByP.pdf",height=2,width=1.95)
p
dev.off()
...
pdf("manuscript_plots/Fig3/3F-RDH10_Visium_Male.pdf",height=1.75,width=2)
p+
    scale_color_manual(values=pal)+
    geom_path(data=dompoly2,aes(x=pxl_col_in_fullres,y=pxl_row_in_fullres,group=Visium.Domain,color=Visium.Domain),size=0.25)+
...
pdf("manuscript_plots/Fig3/3G-RDH10_Visium_female.pdf",height=1.75,width=1.6)
p+
    scale_color_manual(values=pal)+
    geom_path(data=femdompoly2,aes(x=pxl_col_in_fullres,y=pxl_row_in_fullres,group=Visium.Domain,color=Visium.Domain),size=0.25)+
    scale_fill_gradient(low="white",high="black",limits=c(0,3.1))+
...
pdf("manuscript_plots/Fig3/3J-RDH10_Xenium_Male.pdf",height=1.75,width=2)
p
dev.off()
...
pdf("manuscript_plots/Fig3/3K-RDH10_Xenium_female.pdf",height=1.75,width=2)
p
dev.off()
...
other attached packages:
 ...
 [3] ggstance_0.3.7                 ggrepel_0.9.5                 
 [5] sf_1.0-16                      colorout_1.3-0.2              
