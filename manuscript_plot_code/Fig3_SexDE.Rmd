...
pdf("manuscript_plots/Fig3/3E-TAC1_Visium_Female.pdf",height=1.75,width=1.6)
p+
    scale_color_manual(values=pal)+
...
```{r}
RXRGM <- hyp2["RXRG",hyp2$sample_id=="V12Y31-080_A1"]
...
### 
RXRGF <- hyp2["RXRG",hyp2$sample_id=="V12D05-348_D1"]
...
pdf("manuscript_plots/Fig3/3G-RXRG_Visium_female.pdf",height=1.75,width=1.6)
p+
    scale_color_manual(values=pal)+
    geom_path(data=femdompoly2,aes(x=pxl_col_in_fullres,y=pxl_row_in_fullres,group=Visium.Domain,color=Visium.Domain),size=0.25)+
    scale_fill_gradient(low="white",high="black",limits=c(0,3.1))+
