...
spatregs[mouse_pseudobulk_domain=="ARHall",mouse_pseudobulk_domain:="Ms ARC Aggre-\ngated Subclasses"]
spatregs[mouse_pseudobulk_domain=="VMHall",mouse_pseudobulk_domain:="Ms VMH Aggre-\ngated Subclasses"]
...
sexregs[mouse_pseudobulk_domain=="VMH",mouse_pseudobulk_domain:="Ms VMH Aggre-\ngated Subclasses"]
sexregs[mouse_pseudobulk_domain=="ARC",mouse_pseudobulk_domain:="Ms ARC Aggre-\ngated Subclasses"]
...
ggplot(jtres,aes(x=log10(top_n_human),y=spearmancor,col=sphyp_domain))+
    geom_line()+
    facet_wrap(~mouse_pseudobulk_domain,scales="free",nrow = 2)+
    labs(y="Spearman rho (Human vs. Mouse Orthologue\nMarker/DE t-statistics)",x="log10 (Top n Human DEGs or Markers)",col="Human Domain Genes")
dev.off()
```
...
[1] Polychrome_1.5.1  colorout_1.3-0.2  ggtext_0.1.2      gridExtra_2.3    
[5] ggplot2_3.5.1     data.table_1.15.4 rlang_1.1.4      

loaded via a namespace (and not attached):
 [1] gtable_0.3.5         dplyr_1.1.4          compiler_4.4.1      
 [4] tidyselect_1.2.1     Rcpp_1.0.13          xml2_1.3.6          
 [7] stringr_1.5.1        scales_1.3.0         yaml_2.3.9          
[10] fastmap_1.2.0        here_1.0.1           R6_2.5.1            
[13] commonmark_1.9.1     labeling_0.4.3       generics_0.1.3      
[16] knitr_1.48           tibble_3.2.1         munsell_0.5.1       
[19] rprojroot_2.0.4      pillar_1.9.0         utf8_1.2.4          
[22] stringi_1.8.4        xfun_0.45            cli_3.6.3           
[25] withr_3.0.0          magrittr_2.0.3       digest_0.6.36       
[28] grid_4.4.1           gridtext_0.1.5       rstudioapi_0.16.0   
[31] markdown_1.13        lifecycle_1.0.4      vctrs_0.6.5         
[34] scatterplot3d_0.3-44 evaluate_0.24.0      glue_1.7.0          
[37] farver_2.1.2         sessioninfo_1.2.2    fansi_1.0.6         
[40] colorspace_2.1-0     rmarkdown_2.27       htmltools_0.5.8.1   
[43] tools_4.4.1          pkgconfig_2.0.3     
> sessioninfo::session_info()
─ Session info ───────────────────────────────────────────────────────────────────
 setting  value
...
# # change variable ARHall in the collapsed analysis to Pseudobulked\nMs ARC Subclasses
