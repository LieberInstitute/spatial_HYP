---
title: "05-Sex DE heatmaps for cell types in high-conf portions of VMH and ARC domains"
...
```{r}
indomde <- fread("processed-data/08_VMH-ARC cell type sex DE within domains/05-4celltypeARC-and-VMH-hiconf-interior96pctOfDomain_celltypeSexDE.txt")
...
png("plots/08_VMH-ARC cell type sex DE within domains/05-ARC high-conf domain cell type sex DE heatmap FDR.1 p05.png",width=6,height=7,units = "in",res=144)
...
png("plots/08_VMH-ARC cell type sex DE within domains/05-VMH high-conf domain cell type sex DE heatmap FDR.1 p05.png",width=6,height=7,units = "in",res=144)
draw(htmap,heatmap_legend_side="bottom")
dev.off()
```
