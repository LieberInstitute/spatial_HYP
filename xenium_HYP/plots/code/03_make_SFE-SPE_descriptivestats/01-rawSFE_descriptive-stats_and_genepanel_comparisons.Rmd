...
### save as pdf
pdf("plots/03_make_SFE-SPE_descriptivestats/03a-gene_counts_per_cell_datasetwide.pdf",width=5,height=4)
fulldat
dev.off()

pdf("plots/03_make_SFE-SPE_descriptivestats/03b-gene_counts_per_cell_samplewise.pdf",width=7,height=6)
sampwise
dev.off()

### save as png too
png("plots/03_make_SFE-SPE_descriptivestats/03a-gene_counts_per_cell_datasetwide.png",width=5,height=4,units="in",res=150)
fulldat
dev.off()

png("plots/03_make_SFE-SPE_descriptivestats/03b-gene_counts_per_cell_samplewise.png",width=7,height=6,units = "in",res=150)
sampwise
dev.off()
...
png("plots/03_make_SFE-SPE_descriptivestats/03c-gene_counts_by_panel_distribs.png",width=7,height=6,units = "in",res=150)
panelct.plt
dev.off()
...
other attached packages:
 [1] styler_1.10.3                  BiocParallel_1.38.0           
...
loaded via a namespace (and not attached):
 ...
 [15] magrittr_2.0.3            rmarkdown_2.27           
 [17] sass_0.4.9                limma_3.60.2             
 [19] plotly_4.10.4             jquerylib_0.1.4          
 ...
 [47] DelayedArray_0.30.1       DT_0.33                  
 ...
 [61] scater_1.32.0             iterators_1.0.14         
 [63] foreach_1.5.2             tools_4.4.1              
 [65] Rcpp_1.0.12               glue_1.7.0               
 [67] SparseArray_1.4.8         xfun_0.44                
 [69] here_1.0.1                usethis_2.2.3            
 [71] EBImage_4.46.0            dplyr_1.1.4              
 [73] HDF5Array_1.32.0          withr_3.0.0              
 [75] BiocManager_1.30.23       fastmap_1.2.0            
 [77] boot_1.3-30               rhdf5filters_1.16.0      
 [79] fansi_1.0.6               spData_2.3.1             
 [81] rsvd_1.0.5                digest_0.6.35            
 [83] R6_2.5.1                  mime_0.12                
 [85] colorspace_2.1-0          wk_0.9.1                 
 [87] Cairo_1.6-2               jpeg_0.1-10              
 [89] RSQLite_2.3.7             R.methodsS3_1.8.2        
 [91] config_0.3.2              utf8_1.2.4               
 [93] tidyr_1.3.1               generics_0.1.3           
 [95] rtracklayer_1.64.0        class_7.3-22             
 [97] httr_1.4.7                htmlwidgets_1.6.4        
 [99] S4Arrays_1.4.1            spdep_1.3-5              
[101] pkgconfig_2.0.3           gtable_0.3.5             
[103] rsconnect_1.3.1           blob_1.2.4               
[105] htmltools_0.5.8.1         dotCall64_1.1-1          
[107] fftwtools_0.9-11          scales_1.3.0             
[109] png_0.1-8                 attempt_0.3.1            
[111] biocthis_1.14.0           knitr_1.47               
...
[139] magick_2.8.3              Rsamtools_2.20.0         
[141] cli_3.6.2                 locfit_1.5-9.9           
[143] compiler_4.4.1            crayon_1.5.2             
[145] labeling_0.4.3            classInt_0.4-10          
[147] rematch2_2.1.2            fs_1.6.4                 
...
[161] KEGGREST_1.44.0           statmod_1.5.0            
[163] shiny_1.8.1.1             AnnotationHub_3.12.0     
[165] memoise_2.0.1             bslib_0.7.0              
[167] benchmarkmeData_1.0.4     bit_4.0.5                
> sessioninfo::session_info()
─ Session info ───────────────────────────────────────────────────────────
 setting  value
