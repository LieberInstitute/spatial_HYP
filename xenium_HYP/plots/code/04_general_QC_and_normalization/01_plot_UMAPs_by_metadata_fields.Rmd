...
for (i in c(1:length(plotvars))){
    ...
    png(paste0("plots/04_general_QC_and_normalization/01a-rawcount_UMAP_by_",plotvars[i],".png"),width=2000,height=2000)
    print(plt)
    dev.off()
...
```{r}
lct.rastumap <- fread("processed-data/04_general_QC_and_normalization/01b-logcounts_umap_embeddings_and_xenium_metadata.txt.gz")
...
for (i in c(1:length(plotvars))){
    ...
    png(paste0("plots/04_general_QC_and_normalization/01b-logcount_UMAP_by_",plotvars[i],".png"),width=2000,height=2000)
    print(plt)
    dev.off()
