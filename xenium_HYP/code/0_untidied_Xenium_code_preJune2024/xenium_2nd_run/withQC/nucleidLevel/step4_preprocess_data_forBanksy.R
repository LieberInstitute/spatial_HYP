...
dir_out = "/dcs04/hansen/data/ywang/xenium/out_QC_newRun_nuclear/"
dir_data_processed_downstream = "/dcs04/hansen/data/ywang/xenium/data_processed_QC_downstream_newRun_nuclear/"
dir.create(dir_data_processed_downstream)
dir.create(dir_out)
setwd(dir_out)

dir_data_processed_downstream_cellLevel = "/dcs04/hansen/data/ywang/xenium/data_processed_QC_downstream_newRun/"
...
sample_names = c("br1225a","br1225b","br8741c",
...
for(ksample in 1:length(list_sample)){
  ...
  cell_id_kp = readRDS(paste0(dir_data_processed_downstream_cellLevel, "cell_id_kp_oneSample_",sample_name,".rds"))
