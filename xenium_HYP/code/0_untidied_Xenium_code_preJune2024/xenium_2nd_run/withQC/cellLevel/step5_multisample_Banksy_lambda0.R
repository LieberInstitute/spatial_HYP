...
spe_list = readRDS(paste0(dir_data_processed_downstream,"spe_list.rds"))
######################################################################### 
...
spe_joint = readRDS("spe_joint_banksy_lambda0.rds")
...
pdf("multisample_banksy_lambda0_.pdf", width = 40, height = 30)
