...
saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda0_nucleus.rds"))


# spe_joint = readRDS("spe_joint_banksy_lambda0_nucleus.rds")
...
saveRDS(spe_list, file = paste0("spe_list_banksy_lambda0_nucleus.rds"))


######################################################################### 
# Parsing BANKSY output
######################################################################### 
spe_list = readRDS("spe_list_banksy_lambda0_nucleus.rds")
use_agf <- FALSE
lambda <- 0
res <- 0.6
...
pdf(paste0("multisample_banksy_lambda",lambda,"_nucleus.pdf"), width = 40, height = 20)
