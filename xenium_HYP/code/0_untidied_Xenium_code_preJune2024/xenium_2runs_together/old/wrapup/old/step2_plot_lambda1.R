...
pdf("multisample_banksy_2runs_13samples_lambda_1.pdf", width = 60, height = 100/2)
plt(se[,])
# plt(se[,])
dev.off()
...
pdf("multisample_banksy_2runs_13samples_lambda_1_largerPage.pdf", width = 120, height = 60/2)
plt(se)
dev.off()
