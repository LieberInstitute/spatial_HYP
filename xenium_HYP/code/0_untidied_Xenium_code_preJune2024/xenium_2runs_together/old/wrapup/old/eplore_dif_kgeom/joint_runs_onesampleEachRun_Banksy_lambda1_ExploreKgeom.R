...
for(k_geom in c(6,12)){
  ...
  saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda1_oneSampleEachRun_k_geom",k_geom,".rds"))
  ...
  saveRDS(spe_list, file = paste0("spe_list_banksy_lambda1_oneSampleEachRun_k_geom",k_geom,".rds"))
  ...
  library(scater)
  pdf(paste0("multisample_banksy_2runs_oneSampleEachRun_lambda_1_k_geom",k_geom,".pdf"), width = 40, height = 100/4)
  print(plt(se[,]))
  # plt(se[,])
  dev.off()
