...
genes_ARC_marker = genes_ARC_marker[,1]
...
# spe = se[,cellClu=="4"]
# cellClu_used = "4"
if_ARC = ifelse(cellClu=="3", "ARC", "not ARC")

sele = 1:ncol(se)
# sele=sample(1:ncol(se), ncol(se))
spe = se[,sele]
# spe = 
pdf("AnnotatedARCMarker_spatialPlot_boxPlot.pdf",width=30,height=30)
