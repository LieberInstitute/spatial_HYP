...
saveRDS(spe_joint, file = paste0("spe_joint_2runs_banksy_lambda0_nucleus_res1.2.rds"))
print("22")
...
#############
#############
spe_joint = readRDS("spe_joint_2runs_banksy_lambda0_nucleus_res1.2.rds")
...
saveRDS(spe_list, file = paste0("spe_list_2runs_banksy_lambda0_nucleus_res1.2.rds"))
print("44")
...
pdf("multisample_banksy_2runs_13samples_lambda_0_nuclei_res1.2.pdf", width = 60, height = 100/2)
plt(se[,])
# plt(se[,])
dev.off()
...
pdf("multisample_banksy_2runs_13samples_lambda_0_nuclei_UMAP_perCluster_res1.2.pdf", width = 60, height = 3*100/2)
plt_umap_perClu(se[,])
dev.off()
