...
saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda1_13samples_k_geom12.rds"))
...
saveRDS(spe_list, file = paste0("spe_list_banksy_lambda1_13samples_k_geom12.rds"))
...
## do the plots
######################################################################### 
spe_joint  = readRDS("spe_joint_banksy_lambda1_13samples_k_geom12.rds")
# saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda1_13samples_k_geom12.rds"))
head(colData(spe_joint))
...
pdf("multisample_banksy_2runs_13samples_lambda_1_k_geom12.pdf", width = 60, height = 100/2)
plt(se[,])
# plt(se[,])
dev.off()
...
# 
# pdf("multisample_banksy_2runs_13samples_lambda_1_largerPage_k_geom12.pdf", width = 120, height = 60/2)
# plt(se)
# dev.off()
