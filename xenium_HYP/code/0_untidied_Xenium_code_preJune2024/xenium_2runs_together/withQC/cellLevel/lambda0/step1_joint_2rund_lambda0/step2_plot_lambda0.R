...
pdf("multisample_banksy_2runs_lambda_0_res0.6.pdf", width = 60, height = 200/2)
plt(se[,])
# plt(se[,])
dev.off()
...
######################################################################### 
## plot 1st sample, for presentation -- all clusters
######################################################################### 

pdf(paste0("multisample_2runs_banksy_lambda0_res", 0.6, "_for_presentation.pdf"), width = 20, height = 20)
