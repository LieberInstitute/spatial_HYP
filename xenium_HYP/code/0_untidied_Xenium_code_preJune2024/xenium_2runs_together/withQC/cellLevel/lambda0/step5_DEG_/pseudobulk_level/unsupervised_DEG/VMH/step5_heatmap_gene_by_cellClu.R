...
###########
list_pval_allGenes_perClu = readRDS("list_pval_allGenes_perClu_pseudobulkLevel_VMH.rds")
list_fc_allGenes_perClu = readRDS("list_fc_allGenes_perClu_pseudobulkLevel_VMH.rds")
...
pdf(paste0("representative_plots/heatmap_pval_perCellClu_signed_VMH_pseudobulk.pdf"),width=15,height=15)
...
pdf(paste0("representative_plots/heatmap_logFC_perCellClu_signed_VMH_pseudobulk.pdf"),width=15,height=15)
