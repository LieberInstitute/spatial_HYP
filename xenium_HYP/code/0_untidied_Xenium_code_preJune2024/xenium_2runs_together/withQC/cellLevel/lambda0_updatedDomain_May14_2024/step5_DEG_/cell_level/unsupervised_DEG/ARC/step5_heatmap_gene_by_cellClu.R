...
pdf(paste0("representative_plots/heatmap_pval_perCellClu_signed_ARC.pdf"),width=15,height=15)
...
pdf(paste0("representative_plots/heatmap_logFC_perCellClu_signed_ARC.pdf"),width=15,height=15)
