...
###########
list_pval_allGenes_perClu = readRDS("list_pval_allGenes_perClu_pseudobulkLevel_ARC.rds")
list_fc_allGenes_perClu = readRDS("list_fc_allGenes_perClu_pseudobulkLevel_ARC.rds")
list_DEG_perClu = readRDS("list_DEG_perClu_pseudobulkLevel_ARC.rds")
# genes_deg_tmp = c("LYPD6B", "CDH13","MC3R","CDH4","RXRG")
# genes_deg_tmp = c("LYPD6B", "CDH13","CDH4")
# saveRDS(list_DEG_perClu, file = "list_DEG_perClu_pseudobulkLevel_ARC.rds")
# saveRDS(list_pval_allGenes_perClu, file = "list_pval_allGenes_perClu_pseudobulkLevel_ARC.rds")
# saveRDS(list_fc_allGenes_perClu, file = "list_fc_allGenes_perClu_pseudobulkLevel_ARC.rds")
...
mat_pval_signed_MaleHigher[mat_FC_allGenes_perClu[kp_genes_which,] < 0] = 0
mat_pval_signed_FemaleHigher = mat_pval_unsigned
mat_pval_signed_FemaleHigher[mat_FC_allGenes_perClu[kp_genes_which,] > 0] = 0

pdf(paste0("representative_plots/heatmap_pval_perCellClu_signed_ARC_pseudobulk.pdf"),width=15,height=15)
...
pdf(paste0("representative_plots/heatmap_logFC_perCellClu_signed_ARC_pseudobulk.pdf"),width=15,height=15)
