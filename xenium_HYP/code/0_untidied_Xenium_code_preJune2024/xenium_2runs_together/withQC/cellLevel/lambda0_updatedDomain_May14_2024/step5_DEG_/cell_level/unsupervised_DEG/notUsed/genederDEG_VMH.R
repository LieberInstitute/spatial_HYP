...
dim(genes_VMH_sexDEG[-1,])
# [1] 15  7

genes_VMH_sexDEG[-1,1]%in%rownames(spe)
# [1]  TRUE  TRUE  TRUE FALSE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE  TRUE
# [13]  TRUE  TRUE  TRUE

genes_VMH_sexDEG_kp = intersect(genes_VMH_sexDEG[-1,1],
                                rownames(spe))
...
# > length(genes_VMH_sexDEG_kp)
# [1] 14

pdf("AnnotatedSexDEG_VMH_boxplot_perCellCluster.pdf",width=30,height=30)
for(gene_tmp in  genes_VMH_sexDEG_kp){
...
mat_pvalue_F_higher_than_M = mat_pvalue_F_lower_than_M=array(dim=c(19,14))

colnames(mat_pvalue_F_higher_than_M) = colnames(mat_pvalue_F_lower_than_M) = genes_VMH_sexDEG_kp
...
save(mat_pvalue_F_higher_than_M,mat_pvalue_F_lower_than_M,file="pval_DEG_VMH_perCellType.RData")

rownames(mat_pvalue_F_higher_than_M) = rownames(mat_pvalue_F_lower_than_M) = paste0(paste0("cluster ",1:19)," -- ", cellTypeAnnotations)
write.csv(round(mat_pvalue_F_higher_than_M,2), file="mat_pvalue_F_higher_than_M_perCellType_VMH.csv",quote=F)
write.csv(round(mat_pvalue_F_lower_than_M,2), file="mat_pvalue_F_lower_than_M_perCellType_VMH.csv",quote=F)
...
write.csv(mat_pvalue_F_higher_than_M_bin, file="mat_pvalue_F_higher_than_M_perCellType_VMH_binary.csv",quote=F)
write.csv(mat_pvalue_F_lower_than_M_bin, file="mat_pvalue_F_lower_than_M_perCellType_VMH_bin.csv",quote=F)
# fwrite(mat_pvalue_F_higher_than_M_bin, file="mat_pvalue_F_higher_than_M_perCellType_VMH_binary.csv",row.names = T)
...
load("pval_DEG_VMH_perCellType.RData")
# save(mat_pvalue_F_higher_than_M,mat_pvalue_F_lower_than_M,file="pval_DEG_VMH_perCellType.RData")
...
save(mat_pvalue_F_higher_than_M_Adj,mat_pvalue_F_lower_than_M_Adj,
     file="pval_DEG_VMH_perCellTyp_Adj.RData")


dimnames(mat_pvalue_F_higher_than_M_Adj) = dimnames(mat_pvalue_F_lower_than_M_Adj) = dimnames(mat_pvalue_F_higher_than_M)
write.csv(round(mat_pvalue_F_higher_than_M_Adj,2), file="mat_pvalue_F_higher_than_M_Adj_perCellType_VMH.csv",quote=F)
write.csv(round(mat_pvalue_F_lower_than_M_Adj,2), file="mat_pvalue_F_lower_than_M_Adj_perCellType_VMH.csv",quote=F)
...
write.csv(mat_pvalue_F_higher_than_M_adj_bin, file="mat_pvalue_F_higher_than_M_perCellType_VMH_adj_binary.csv",quote=F)
write.csv(mat_pvalue_F_lower_than_M_adj_bin, file="mat_pvalue_F_lower_than_M_perCellType_VMH_adj_bin.csv",quote=F)
...
write.csv(mat_adj_bin_overall, file="mat_adj_bin_perCellType_VMH_overall.csv",quote=F)

################  add FC to the table
mat_adj_bin_overall = read.csv("mat_adj_bin_perCellType_VMH_overall.csv")


load("FC_DEG_VMH_perCellType.RData")
# save(mat_FC_F_higher_than_M,mat_FC_F_lower_than_M,file="FC_DEG_VMH_perCellType.RData")
...
write.csv(mat_adj_bin_overall_withFC, file="mat_adj_bin_overall_withFC_VMH.csv",quote=F)
