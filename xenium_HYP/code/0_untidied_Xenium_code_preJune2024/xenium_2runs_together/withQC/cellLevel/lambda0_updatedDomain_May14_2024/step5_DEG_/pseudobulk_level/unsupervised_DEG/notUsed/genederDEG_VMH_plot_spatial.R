...
for(gene_tmp in genes_VMH_sexDEG_kp ){
  ...
  dir_geneTmp = paste0("VMH_spatial_plot_",gene_tmp)
  dir.create(dir_geneTmp)
  # dir.create(paste0("spatial_plot_",gene_tmp))
  for(cellType_clu in cellType_clu_unique){
    print(cellType_clu)
    pdf(paste0(dir_geneTmp,"/VMH_DEG_spatialperCellClu",cellType_clu,".pdf"),width=30,height=30)
...
for(gene_tmp in genes_VMH_sexDEG_kp ){
  ...
  # dir.create(paste0("spatial_plot_",gene_tmp))
  for(cellType_clu in cellType_clu_unique){
    dir_clusterTmp = paste0("VMH_spatial_plot_cluster",cellType_clu)
    dir.create(dir_clusterTmp)
    
    print(cellType_clu)
    pdf(paste0(dir_clusterTmp,"/VMH_DEG_spatial_",gene_tmp,".pdf"),width=30,height=30)
