...
for(sample in sample_names){
  ...
  knn_pred = readRDS(paste0("updated_May14_2024/knn_predARC_",sample,"_k50.rds"))
  # saveRDS(knn_pred, file = paste0("knn_predARC_",sample,".rds") )
  knn_pred_arc_c[which_sample] = knn_pred
}
knn_pred_arc = knn_pred_arc_c > 0.3
...
for(sample in sample_names){
  ...
  saveRDS(knn_pred, file = paste0("updated_May14_2024/knn_predARC_",sample,"_k500_2ndRun.rds") )
}
...
saveRDS(knn_pred_arc_c_, file = paste0("updated_May14_2024/knn_ARC_twoRounds.rds") )
knn_pred_arc_c_ = readRDS("updated_May14_2024/knn_ARC_twoRounds.rds")
# ARC not ARC 
# 118741  760655 
...
for(cutoff in c(0.1)){
  pdf(paste0("updated_May14_2024/multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k500_2ndRun_cutoff",cutoff,".pdf"), width = 60, height = 100/2)
