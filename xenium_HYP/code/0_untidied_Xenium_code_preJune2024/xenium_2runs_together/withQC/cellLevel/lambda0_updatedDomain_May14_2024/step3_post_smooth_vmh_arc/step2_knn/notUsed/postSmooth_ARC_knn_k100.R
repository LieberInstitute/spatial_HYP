...
for(sample in sample_names){
  ...
  saveRDS(knn_pred, file = paste0("knn_predARC_",sample,"_k100_2ndRun.rds") )
}
...
for(sample in sample_names){
  print(sample)
  which_sample = which(colData(spe_joint)[,"sample_id"] == sample)
  knn_pred = readRDS(paste0("knn_predARC_",sample,"_k100_2ndRun.rds"))
  knn_pred_arc_c[which_sample] = knn_pred
}
...
pdf("multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k100_2ndRun.pdf", width = 60, height = 100/2)
...
pdf("multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k100_2ndRun_cutoff06_09.pdf", width = 60, height = 100/2)
