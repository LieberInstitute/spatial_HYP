...
pdf("multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k200_2ndRun.pdf", width = 60, height = 100/2)
...
pdf("multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k200_2ndRun_cutoff06_09.pdf", width = 60, height = 100/2)
