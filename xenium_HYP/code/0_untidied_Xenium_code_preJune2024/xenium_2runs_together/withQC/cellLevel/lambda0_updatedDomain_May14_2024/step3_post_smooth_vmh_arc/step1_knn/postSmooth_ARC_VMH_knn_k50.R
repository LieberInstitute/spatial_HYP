...
if_ARC[colData(spe_joint)$clust_M0_lam0_k50_res2 %in% c("12", "33", "25")] = 1
length(if_ARC)
...
for(sample in sample_names){
  ...
  saveRDS(knn_pred, file = paste0("updated_May14_2024/knn_predARC_",sample,"_k50.rds") )
...
for(cutoff in c(0.5)){
  ...
  pdf(paste0("updated_May14_2024/multisample_banksy_2runs_13samples_domain_knn_pred_arc_c_k50_cutoff",cutoff,".pdf"), width = 60, height = 100/2)
