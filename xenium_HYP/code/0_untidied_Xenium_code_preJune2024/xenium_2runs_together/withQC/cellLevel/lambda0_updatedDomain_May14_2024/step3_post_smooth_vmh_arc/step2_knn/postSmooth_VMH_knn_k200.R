...
for(sample in sample_names){
  ...
  saveRDS(knn_pred, file = paste0("updated_May14_2024/knn_predVMH_",sample,"_k200_2ndRun.rds") )
...
for(sample in sample_names){
  print(sample)
  which_sample = which(colData(spe_joint)[,"sample_id"] == sample)
  knn_pred = readRDS(paste0("updated_May14_2024/knn_predVMH_",sample,"_k200_2ndRun.rds"))
  # saveRDS(knn_pred, file = paste0("knn_predARC_",sample,".rds") )
  knn_pred_vmh_c[which_sample] = knn_pred
}
...
saveRDS(knn_pred_vmh_c_, file = paste0("updated_May14_2024/knn_VMH_twoRounds.rds") )
...
pdf("updated_May14_2024/multisample_banksy_2runs_13samples_domain_knn_pred_vmh_c_k200_2ndRun_updated.pdf", width = 60, height = 100/2)
