...
pdf(paste0("multisample_banksy_2runs_lambda_0_res",res,"_annotatedCellClu.pdf"), width = 60, height = 500/2)
plt(se[,])
dev.off()
plt <- function(se_, 
                grp1 = colData(se)[,"sample_id"]%in%sample_names_old, 
...
pdf(paste0("multisample_banksy_2runs_lambda_0_res",res,"_annotatedCellClu_umapOnly.pdf"), width = 60/2, height = 500/2/4)
plt(se[,])
dev.off()
