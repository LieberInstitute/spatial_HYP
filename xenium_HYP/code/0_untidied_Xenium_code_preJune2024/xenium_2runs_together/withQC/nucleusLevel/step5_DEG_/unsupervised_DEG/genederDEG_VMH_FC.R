...
# 
# colnames(mat_log2FC_F_higher_than_M) = colnames(mat_log2FC_F_lower_than_M) = genes_VMH_sexDEG_kp
...
mat_FC_F_higher_than_M = mat_FC_F_lower_than_M=array(dim=c(19,14))

colnames(mat_FC_F_higher_than_M) = colnames(mat_FC_F_lower_than_M) = genes_VMH_sexDEG_kp
...
write.csv(round(mat_FC_F_higher_than_M,2), file="mat_FC_F_higher_than_M_perCellType_VMH.csv",quote=F)
write.csv(round(mat_FC_F_lower_than_M,2), file="mat_FC_F_lower_than_M_perCellType_VMH.csv",quote=F)
