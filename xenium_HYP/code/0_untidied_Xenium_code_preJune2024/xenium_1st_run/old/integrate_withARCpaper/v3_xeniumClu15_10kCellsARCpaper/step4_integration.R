...
obj_xenium = readRDS(paste0( "obj_xenium_nuclei_cellClu15.rds"))
...
bm280k.integrated <- IntegrateData(anchorset = anchors, dims = 1:5, k.weight =50)
saveRDS(bm280k.integrated, file = "integrated_subARCpaper_XemiumClu15Only.rds")
