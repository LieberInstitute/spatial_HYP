...
########## 
se_seurat = readRDS(paste0( "obj_xenium_nuclei.rds"))

set.seed(111)
rd_ = sample(1:ncol(se_seurat), 10000)
se_seurat_sub = se_seurat[,rd_]
saveRDS(se_seurat_sub, file="obj_xenium_nuclei_sub.rds")

########## 
obj_xenium = readRDS(paste0( "obj_xenium_nuclei.rds"))
obj_xenium_cellClu15 = obj_xenium[,Idents(obj_xenium)=="15"]
# obj_xenium_cellClu15 = NormalizeData(obj_xenium_cellClu15)
# obj_xenium_cellClu15 = FindVariableFeatures(obj_xenium_cellClu15)
saveRDS(obj_xenium_cellClu15, file="obj_xenium_nuclei_cellClu15.rds")
