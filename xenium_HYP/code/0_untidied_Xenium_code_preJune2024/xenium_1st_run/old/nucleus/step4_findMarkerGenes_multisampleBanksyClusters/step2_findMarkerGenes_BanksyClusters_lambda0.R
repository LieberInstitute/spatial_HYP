...
pdf(paste0("markerGenes_top10_multisampleBanksy_lambda_",lambdaName,"_nucleus.pdf"), width = 20, height = 20)
  ...
  write.csv(top10, file=paste0(dir_data_processed_banksy, "top10_markerGenes_multiSampleBanksy_lambda",lambdaName,"_nucleus.csv"))
...
########
# gad1, gad2, slc32a1, slc17a6, and slc17a7
pdf(paste0("markerGenes_top10_multisampleBanksy_lambda_",lambdaName,"_nucleus_ReOrdered.pdf"), width = 20, height = 20)
obj = CreateSeuratObject(assays(se)$counts, project = paste0("marker genes"))
obj = NormalizeData(obj)
obj = ScaleData(obj)
Idents(obj) = colData(se)[,paste0("clust_M0_lam", lambda, "_k50_res0.6")]
