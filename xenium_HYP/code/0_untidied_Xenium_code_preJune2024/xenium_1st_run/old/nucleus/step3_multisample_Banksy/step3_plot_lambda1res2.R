...
spe_joint  = readRDS(paste0("spe_joint_banksy_lambda",lambdaName,"_res2.rds"))
...
pdf(paste0("multisample_banksy_lambda_", lambdaName, "_res2.pdf"), width = 40, height = 60)
plt()
dev.off()
...
pdf(paste0("multisample_banksy_lambda_", lambdaName, "_largerPage_res2.pdf"), width = 80, height = 60)
plt()
dev.off()

pdf(paste0("multisample_banksy_lambda_", lambdaName, "_smallerPage_res2.pdf"), width = 20, height = 30)
plt()
dev.off()
