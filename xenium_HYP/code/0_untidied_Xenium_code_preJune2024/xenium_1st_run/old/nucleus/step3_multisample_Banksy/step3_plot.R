...
pdf(paste0("multisample_banksy_lambda_",lambda,"_nucleus.pdf"), width = 40, height = 60)
plt()
dev.off()
...
pdf(paste0("multisample_banksy_lambda_",lambda,"_largerPage_nucleus.pdf"), width = 80, height = 60)
plt()
dev.off()
