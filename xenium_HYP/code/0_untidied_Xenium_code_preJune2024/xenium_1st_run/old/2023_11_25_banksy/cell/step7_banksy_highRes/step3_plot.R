...
spe_joint  = readRDS(paste0("spe_joint_banksy_lambda",lambda,"_res2.rds"))
...
pdf("multisample_banksy_lambda_1_res2.pdf", width = 40, height = 60)
plt()
dev.off()
...
pdf("multisample_banksy_lambda_1_largerPage_res2.pdf", width = 80, height = 60)
plt()
dev.off()


pdf("multisample_banksy_lambda_1_smallerPage_res2.pdf", width = 20, height = 30)
plt()
dev.off()
