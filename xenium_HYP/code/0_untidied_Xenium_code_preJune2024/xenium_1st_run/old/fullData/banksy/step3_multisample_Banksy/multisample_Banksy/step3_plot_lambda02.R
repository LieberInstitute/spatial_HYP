...
pdf(paste0("multisample_banksy_lambda_02_largerPage", lambdaName, ".pdf"), width = 80, height = 60)
plt()
dev.off()

pdf(paste0("multisample_banksy_lambda_02_smallerPage", lambdaName, ".pdf"), width = 20, height = 30)
plt()
dev.off()
