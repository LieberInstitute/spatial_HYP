...
saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda1_arcOnly_res06_30neighbours.rds"))
# spe_list  = readRDS("spe_list_banksy_lambda1_arcOnly.rds")
...
saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda1_arcOnly_res06_30neighbours.rds"))
spe_joint = readRDS("spe_joint_banksy_lambda1_arcOnly_res06_30neighbours.rds")
...
saveRDS(spe_list, file = paste0("spe_list_banksy_lambda1_arcOnly_res06_30neighbours.rds"))


######################################################################### 
# Parsing BANKSY output
######################################################################### 
spe_list = readRDS("spe_list_banksy_lambda1_arcOnly_res06_30neighbours.rds")
use_agf <- FALSE
lambda <- 1
res <- 0.6
cnm <- sprintf("clust_M%s_lam%s_k50_res%s", as.numeric(use_agf), lambda, res)
...
pdf("multisample_banksy_lambda1_arcOnly_res06_30neighbours.pdf", width = 40, height = 20)
