---
title: "Hyp xenium-molecule experiment to SPE to harmony to seurat louvain multilevel
  clustering"
...
### Example seurat handling of t he xenium data (up to the point of clustering, without any gene filters), is at the end of this Rmd. ###
...
xens <- MoleculeExperiment::readXenium("~/Desktop/23-10-24-Xen/20231019__161052__101923_KMon101923/",keepCols = "essential",addBoundaries = "cell")
...
job({saveRDS(xens,"~/Desktop/hypxenia.cells.as.SPE_unfiltered.RDS")
