...
xens <- MoleculeExperiment::readXenium(paste0(dir_data,"/20231019__161052__101923_KMon101923/"),keepCols = "essential",addBoundaries = "nucleus")
...
saveRDS(xens, file=paste0(dir_data_processed, "xens_nucleus.rds"))
