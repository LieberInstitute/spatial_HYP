...
saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda0_UMAP.rds"))
...
for(res in c(0.5, 1, 1.2, 2, 4, 5)){
  ...
  # saveRDS(spe_joint, file = paste0("spe_joint_banksy_lambda0_res", res, ".rds"))
  ...
  saveRDS(list_colData, file = paste0("list_colData_banksy_lambda0_res", res, ".rds"))
  
  # saveRDS(spe_list, file = paste0("spe_list_banksy_lambda0_res", res, ".rds"))
}
