---
title: "02-Cell Type Sex DE within 3-type-ARC and VMH Domains"
...
finesmoove <- fread("processed-data/07_Domains-subdomains_by_knnSmoothing_Banksytypes/03a-Alt_smoothedARC_no-clus-X23_no-X19.txt")
finesmoove <- finesmoove[,.(rn,dualassignedSmooth2_ARC3)]
...
hypb$isARCsmoove3cell <- finesmoove$dualassignedSmooth2_ARC3

hyp.fineadom <- hypb[,hypb$isARCsmoove3cell=="ARCsmooth2_3celltype"]
hyp.finevdom <- hypb[,hypb$isARCsmoove3cell=="VMH_yi_2stage"]
...
## min samples 5 -- size of the smaller sex group in total samps (females)-- one female sample has no ARC at all with this smoothing unfortunately
...
### Warning message: In dreamlet::processAssays(hyp.adom.ag, min.cells = 10, min.count = 10,  : Not enough samples retained or model fit fails: X21, X28, X30, X36, X37, X40
...
dl.rf.res[,domain:="ARC_onlyX15.X31.X33_smoothed"]
...
### Warning message: In dreamlet::processAssays(hyp.adom.ag, min.cells = 10, min.count = 10,  : 
...
## append rowData, domain, cell type annots to result table
dl.rf.res[,domain:="VMH_dual.w.onlyX15.X31.X33ARC"]
...
### concat and save
```{r}
dl.rf.res.fineadom <- dl.rf.res.fineadom[,.(assay,bjm_annot,ID,logFC_MvF,adj.P.Val,t)]

setnames(dl.rf.res.fineadom,c("logFC_MvF","adj.P.Val","t"),c("logFC_MvF_3typeARC","FDR_3typeARC","t_3typeARC"))

dl.rf.res.finevdom <- dl.rf.res.finevdom[,.(assay,bjm_annot,ID,logFC_MvF,adj.P.Val,t)]

setnames(dl.rf.res.finevdom,c("logFC_MvF","adj.P.Val","t"),c("logFC_MvF_VMH","FDR_VMH","t_VMH"))

dualassignsARC3res <- merge.data.table(dl.rf.res.fineadom,dl.rf.res.finevdom,by=c("assay","bjm_annot","ID"),all.x=T,all.y=T)

## save
fwrite(dualassignsARC3res,"processed-data/08_VMH-ARC cell type sex DE within domains/02-3celltypeARC-and-VMH-dualassignedDomains_celltypeSexDE.txt")
```
