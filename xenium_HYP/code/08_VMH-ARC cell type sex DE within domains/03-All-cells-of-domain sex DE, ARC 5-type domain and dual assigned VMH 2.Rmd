...
### use dreamlet to run random-donor-effects sex DE (mirroring the procedures used for visium)
```{r}
...
dl.rf <- dreamlet::processAssays(hyp.domwise.ag,min.cells = 10,min.count = 10,min.samples = 5,min.prop = 0.1,normalize.method = "TMM",useCountsWeights = T,BPPARAM = MulticoreParam(8),formula = ~Sex+(1|BrNum))
