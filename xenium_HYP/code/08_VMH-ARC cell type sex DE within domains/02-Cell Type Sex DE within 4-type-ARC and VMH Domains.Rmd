...
### use dreamlet to run random-donor-effects sex DE (mirroring the procedures used for visium) for the 4-cluster ARC definition. include slide run as a covar
```{r}
...
### Warning message: In dreamlet::processAssays(hyp.adom.ag, min.cells = 10, min.count = 10,  : Not enough samples retained or model fit fails: X28, X30, X34, X37, X40
...
### Warning message: In dreamlet::processAssays(hyp.adom.ag, min.cells = 10, min.count = 10,  : Not enough samples retained or model fit fails: X10, X17, X21, X28, X31, X32, X33, X34, X37, X40
