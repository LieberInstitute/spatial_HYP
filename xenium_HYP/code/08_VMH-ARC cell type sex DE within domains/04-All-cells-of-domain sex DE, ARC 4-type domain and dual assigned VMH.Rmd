...
### use dreamlet to run random-donor-effects sex DE (mirroring the procedures used for visium), with covar for slide run
```{r}
...
fwrite(dl.rf.res,"processed-data/08_VMH-ARC cell type sex DE within domains/04-4typeARC-and-dualassignVMH_domainwise_sexDE.txt",sep='\t',quote=F,row.names=F,col.names=T)

```

### notably here, only PHLDB2 is FDR<0.05, in ARC (all others ARC and VMH > 0.5).
