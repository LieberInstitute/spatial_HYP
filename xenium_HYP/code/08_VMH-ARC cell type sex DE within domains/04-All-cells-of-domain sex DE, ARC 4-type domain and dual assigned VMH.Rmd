...
setnames(fulldgelres,c("rn","logFC"),c("gene_name","logFC_MvF"))

## append cell type annotations
fulldgelres <- fulldgelres[,.(domain,gene_name,logFC_MvF,adj.P.Val,t,B,P.Value,AveExpr)]
...
fwrite(fulldgelres,"processed-data/08_VMH-ARC cell type sex DE within domains/04-4typeARC-and-dualassignVMH_domainwise_sexDE.txt",sep='\t',quote=F,row.names=F,col.names=T)
