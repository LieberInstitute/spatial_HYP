...
tmpcd <- merge.data.table(tmpcd,mscriptids[,.(sample_id,manuscript_id_wsex)],by.x="Sample",by.y="sample_id",all.x=T)
...
## subset the cellwise labels to these clusters,, and label those cells
