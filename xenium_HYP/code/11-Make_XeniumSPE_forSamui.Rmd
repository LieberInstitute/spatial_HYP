...
```{r}
## load xenium SPE, main clustering results and their annots, and drop cells from sample-specific clusters
...
vmharccellanno <- fread("processed-data/07_Domains-subdomains_by_knnSmoothing_Banksytypes/04e_ARC_and_VMH_cluster_identities_based_on_cellgroup_1vall.txt")
...
## subset the cellwise labels to these clusters, subset the xenium to these cells, and label those cells
bkcl <- merge.data.table(bkcl,bkanno,by.y="clus",by.x="cl")
bkcl <- DataFrame(bkcl,row.names=bkcl$rn)[colnames(hypx),]
hypx$Banksy_M0lam0_kgeom6_clusters <- bkcl$bjm_annot
...
saveRDS(hypx,"processed-data/11-XeniumSPE_forSamui.RDS")
```
...
loaded via a namespace (and not attached):
 [1] EBImage_4.46.0            R.utils_2.12.3            bitops_1.0-7             
 [4] fastmap_1.2.0             RCurl_1.98-1.14           digest_0.6.36            
 [7] lifecycle_1.0.4           sf_1.0-16                 statmod_1.5.0            
[10] terra_1.7-78              magrittr_2.0.3            compiler_4.4.1           
[13] tools_4.4.1               yaml_2.3.9                knitr_1.48               
[16] S4Arrays_1.4.1            dqrng_0.4.1               htmlwidgets_1.6.4        
[19] sp_2.1-4                  classInt_0.4-10           here_1.0.1               
[22] DelayedArray_0.30.1       abind_1.4-5               KernSmooth_2.23-24       
[25] HDF5Array_1.32.0          R.oo_1.26.0               grid_4.4.1               
[28] beachmat_2.20.0           e1071_1.7-14              Rhdf5lib_1.26.0          
[31] edgeR_4.2.0               zeallot_0.1.0             cli_3.6.3                
[34] rmarkdown_2.27            crayon_1.5.3              rstudioapi_0.16.0        
[37] httr_1.4.7                rjson_0.2.21              DelayedMatrixStats_1.26.0
[40] spdep_1.3-5               scuttle_1.14.0            DBI_1.2.3                
[43] proxy_0.4-27              rhdf5_2.48.0              zlibbioc_1.50.0          
[46] parallel_4.4.1            s2_1.1.6                  XVector_0.44.0           
[49] tiff_0.1-12               boot_1.3-30               Matrix_1.7-0             
[52] jsonlite_1.8.8            spData_2.3.1              fftwtools_0.9-11         
[55] BiocNeighbors_1.22.0      jpeg_0.1-10               magick_2.8.3             
[58] locfit_1.5-9.10           limma_3.60.3              units_0.8-5              
[61] DropletUtils_1.24.0       codetools_0.2-20          deldir_2.0-4             
[64] UCSC.utils_1.0.0          htmltools_0.5.8.1         rhdf5filters_1.16.0      
[67] GenomeInfoDbData_1.2.12   R6_2.5.1                  wk_0.9.2                 
[70] sparseMatrixStats_1.16.0  sfheaders_0.4.4           rprojroot_2.0.4          
[73] evaluate_0.24.0           lattice_0.22-6            R.methodsS3_1.8.2        
[76] png_0.1-8                 class_7.3-22              Rcpp_1.0.13              
[79] SparseArray_1.4.8         xfun_0.45                
> sessioninfo::session_info()
─ Session info ────────────────────────────────────────────────────────────────────
 setting  value
