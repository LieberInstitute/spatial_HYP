...
## load SFE and annot clusters; subset to VMH clusters (X12,X18,X30; X36 as well, but that's sample specific so it may not play nicely, we'll see)
...
hypvmh <- hypb[,hypb$label %in% c("X12","X18","X30","X36")]
```
