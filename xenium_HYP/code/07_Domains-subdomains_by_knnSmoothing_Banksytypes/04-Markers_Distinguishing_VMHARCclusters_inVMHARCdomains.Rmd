...
## for computational effish subset to ARC and VMH cells
...
arcdomcluspair.2[,clust1.2:=clust2]
arcdomcluspair.2[,clust2.2:=clust1]
arcdomcluspair.2[,clust1:=clust1.2]
arcdomcluspair.2[,clust2:=clust2.2]
arcdomcluspair.2[,value:=-value]
set(arcdomcluspair.2,j=c("clust1.2","clust2.2"),value=NULL)
arcdomcluspair.l <- rbind(arcdomcluspair.l1,arcdomcluspair.l2)
...
fwrite(arcdomcluspair.out,"processed-data/07_Domains-subdomains_by_knnSmoothing_Banksytypes/04b-ARCtypes-inARCdom_pairwise_markers.txt",sep='\t',quote=F)
...
vmhdomcluspair.l <- vmhdomcluspair[stat=="logFC"&value>0]
...
[103] fftwtools_0.9-11          scales_1.3.0              png_0.1-8                
[106] attempt_0.3.1             knitr_1.48                rstudioapi_0.16.0        
