...
### run the marker analyses two ways: one vs "all" (i.e., other ARC or VMH types in the domain), aand pairwise. conveniently both are wrapped into spatialLIBD registration_wrapper calls. note that this is different from how we set it up for Visium, collapsed other BayesSpace clusters together explicitly where we used the pairwise functions. 
```{r}
