...
set.seed(42)
hypx <- scater::runPCA(hypx,subset_row=genetargeting,assay.type="counts",BPPARAM=bpp)

set.seed(42)
hypx <- scater::runUMAP(hypx,dimred="PCA",BPPARAM=bpp)
...
fwrite(rastumap,"processed-data/04_general_QC_and_normalization/01-umap_embeddings_and_xenium_metadata.txt.gz",sep='\t',quote=F)
```
...
# save the UMAP embeddings w/ metadata as a table to plot from without needing to load up the whole SFE
fwrite(logct.rastumap,"processed-data/04_general_QC_and_normalization/01b-logcounts_umap_embeddings_and_xenium_metadata.txt.gz",sep='\t',quote=F)
```
...
loaded via a namespace (and not attached):
 ...
 [59] e1071_1.7-14              iterators_1.0.14         
...
[119] AnnotationDbi_1.66.0      restfulr_0.0.15          
[121] s2_1.1.6                  pillar_1.9.0             
[123] grid_4.4.1                vctrs_0.6.5              
[125] promises_1.3.0            BiocSingular_1.20.0      
[127] dbplyr_2.5.0              beachmat_2.20.0          
[129] cluster_2.1.6             xtable_1.8-4             
[131] sfheaders_0.4.4           beeswarm_0.4.0           
[133] paletteer_1.6.0           evaluate_0.24.0          
[135] zeallot_0.1.0             magick_2.8.3             
[137] Rsamtools_2.20.0          cli_3.6.2                
[139] locfit_1.5-9.9            compiler_4.4.1           
[141] crayon_1.5.2              classInt_0.4-10          
[143] rematch2_2.1.2            ggbeeswarm_0.7.2         
[145] viridisLite_0.4.2         deldir_2.0-4             
[147] munsell_0.5.1             lazyeval_0.2.2           
[149] tiff_0.1-12               Matrix_1.7-0             
[151] ExperimentHub_2.12.0      benchmarkme_1.0.8        
[153] sparseMatrixStats_1.16.0  bit64_4.0.5              
[155] Rhdf5lib_1.26.0           KEGGREST_1.44.0          
[157] statmod_1.5.0             shiny_1.8.1.1            
[159] AnnotationHub_3.12.0      igraph_2.0.3             
