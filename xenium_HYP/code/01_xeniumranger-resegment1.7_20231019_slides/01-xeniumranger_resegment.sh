...
#SBATCH -o /dcs04/lieber/marmaypag/spatialHYP_LIBD4195/spatial_HYP/xenium_HYP/code/01_xeniumranger-resegment1.7_20231019_slides/logs/xeniumresegment_2023slides_%a.out
#SBATCH -e /dcs04/lieber/marmaypag/spatialHYP_LIBD4195/spatial_HYP/xenium_HYP/code/01_xeniumranger-resegment1.7_20231019_slides/logs/xeniumresegment_2023slides_%a.err
#SBATCH --array=1-6
