...
```{r}
msigdbfull <- readRDS("data/11-GSEA/01a-Marker msigdb_1,2,3,5,6,8 GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd.RDS")

msigdbcollapsed <- readRDS("data/11-GSEA/01c-Marker mSigDB_1,2,3,5,6,8 GSEA clpspath mainPathways-only.RDS")
...
```{r}
tffull <- readRDS("data/11-GSEA/02a-Marker TF-target GSEA svg10-hmnyLmdaNA_BS60k-k15-k20-k31-k15clpsd.RDS")

tfcollapsed <- readRDS("data/11-GSEA/02c-Marker TF-target GSEA clpspath mainPathways-only.RDS")

tfxprd <- readRDS("data/11-GSEA/08-Marker TF-target GSEA results from 02a filtered to TFs expressed in avg 3pct of cluster spots and at least 1pct of cluster spots in 5samps.RDS")
...
```{r}
mkdisres <- readRDS("data/11-GSEA/05-Common variant disease gene enrichment in markers.RDS")
...
mkdisres[`BayesSpace Run`=="k15"&Domain=="X3",Domain:="ARC.1"]
mkdisres[`BayesSpace Run`=="k15"&Domain=="X5",Domain:="ARC.2"]
mkdisres[`BayesSpace Run`=="k15"&Domain=="X11",Domain:="VMH.1"]
mkdisres[`BayesSpace Run`=="k15"&Domain=="X12",Domain:="VMH.2"]

### add the k20/k31 ARC and VMH cluster identifiers as used elsewhere
mkdisres[Domain=="X7"&`BayesSpace Run`=="k20",Domain:="VMH20.1"]
mkdisres[Domain=="X9"&`BayesSpace Run`=="k20",Domain:="VMH20.2"]
mkdisres[Domain=="X13"&`BayesSpace Run`=="k20",Domain:="VMH20.3"]
mkdisres[Domain=="X14"&`BayesSpace Run`=="k20",Domain:="ARC20.1"]
mkdisres[Domain=="X18"&`BayesSpace Run`=="k20",Domain:="ARC20.2"]

mkdisres[Domain=="X3"&`BayesSpace Run`=="k31",Domain:="VMH31.1"]
mkdisres[Domain=="X4"&`BayesSpace Run`=="k31",Domain:="VMH31.2"]
mkdisres[Domain=="X6"&`BayesSpace Run`=="k31",Domain:="VMH31.3"]
mkdisres[Domain=="X19"&`BayesSpace Run`=="k31",Domain:="VMH31.4"]
mkdisres[Domain=="X20"&`BayesSpace Run`=="k31",Domain:="VMH31.5"]
mkdisres[Domain=="X29"&`BayesSpace Run`=="k31",Domain:="VMH31.6"]
mkdisres[Domain=="X1"&`BayesSpace Run`=="k31",Domain:="ARC31.1"]
mkdisres[Domain=="X7"&`BayesSpace Run`=="k31",Domain:="ARC31.2"]
mkdisres[Domain=="X8"&`BayesSpace Run`=="k31",Domain:="ARC31.3"]
mkdisres[Domain=="X21"&`BayesSpace Run`=="k31",Domain:="ARC31.4"]
