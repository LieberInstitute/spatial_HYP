...
### drop mito genes and sex chromosomal genes (i.e. autosomal analysis)
...
saveRDS(allsexdedisres,"data/11-GSEA/06-Common variant disease gene enrichment in sex DEGs.RDS")
```
