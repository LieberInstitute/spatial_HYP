...
```{r}
vmhsvg <- readRDS("data/08-Nucleus-specific SVGs/01a-VMH_1count-5pctspot_fulloutput.RDS")

arcsvg <- readRDS("data/08-Nucleus-specific SVGs/02a-ARC_1count-5pctspot_fulloutput.RDS")
...
vmhsum <- fread("data/08-Nucleus-specific SVGs/01b-VMH nnSVG nomsig genes and ranks per sample.txt")
arcsum <- fread("data/08-Nucleus-specific SVGs/02b-ARC nnSVG nomsig genes and ranks per sample.txt")
