...
nnsvg_ranks[,meanrank:=rowMeans(.SD,na.rm=T),.SDcols=c(3:ncol(nnsvg_ranks)-1)]
nnsvg_ranks <- nnsvg_ranks[,samples_signif:=rowSums(!is.na(.SD)),.SDcols=c(3:ncol(nnsvg_ranks)-1)]
...
```{r}
nnsvg_ranks <- nnsvg_ranks[samples_signif>2]
