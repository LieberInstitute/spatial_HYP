...
restabs <- bpmapply(x=vde,y=cluspairs,SIMPLIFY = F, BPPARAM=sbp,FUN=function(x,y){
    restab <- as.data.frame(matrix(nrow=nrow(y),ncol=4))
    ...
    for (i in c(1:nrow(y))){
        ...
        restab[i,1] <- msassay
        restab[i,2] <- hgassay
        restab[i,3] <- cor(tmpcompare$tms,tmpcompare$t,use="pairwise.complete.obs",method="pearson")
         restab[i,4] <- cor(tmpcompare$tms,tmpcompare$t,use="pairwise.complete.obs",method="spearman")
         rm(tmpms,tmpx,tmpcompare,mgassay,hgassay)
    }
    rm(i)
...
saveRDS(restabs,"data/12-Mouse comparisons/03-Yao23-subclass-MvFsexDE-tstat_correls_to_k15-20-31-15collapsed.RDS")
```
...
[35] knitr_1.45                Matrix_1.6-5             
[37] tidyselect_1.2.0          rstudioapi_0.15.0        
[39] abind_1.4-5               yaml_2.3.8               
[41] codetools_0.2-19          curl_5.2.0               
[43] lattice_0.22-5            tibble_3.2.1             
[45] Biobase_2.62.0            treeio_1.26.0            
[47] withr_3.0.0               KEGGREST_1.42.0          
[49] evaluate_0.23             gridGraphics_0.5-1       
[51] BiocFileCache_2.10.1      xml2_1.3.6               
[53] filelock_1.0.3            pillar_1.9.0             
[55] ggtree_3.10.0             ggpubr_0.6.0             
[57] carData_3.0-5             ggfun_0.1.4              
[59] plotly_4.10.4             generics_0.1.3           
[61] rprojroot_2.0.4           RCurl_1.98-1.14          
[63] hms_1.1.3                 munsell_0.5.0            
[65] scales_1.3.0              tidytree_0.4.6           
[67] glue_1.7.0                lazyeval_0.2.2           
[69] tools_4.3.2               ggsignif_0.6.4           
[71] babelgene_22.9            fs_1.6.3                 
[73] XML_3.99-0.16.1           grid_4.3.2               
[75] tidyr_1.3.1               ape_5.7-1                
[77] AnnotationDbi_1.64.1      colorspace_2.1-0         
[79] nlme_3.1-164              GenomeInfoDbData_1.2.11  
[81] patchwork_1.2.0           homologene_1.4.68.19.3.27
[83] cli_3.6.2                 rappdirs_0.3.3           
[85] fansi_1.0.6               viridisLite_0.4.2        
[87] dplyr_1.1.4               gtable_0.3.4             
[89] rstatix_0.7.2             yulab.utils_0.1.4        
[91] digest_0.6.34             ggplotify_0.1.2          
[93] htmlwidgets_1.6.4         memoise_2.0.1            
[95] htmltools_0.5.7           lifecycle_1.0.4          
[97] httr_1.4.7                here_1.0.1               
[99] bit64_4.0.5              
> sessioninfo::session_info()
─ Session info ───────────────────────────────────────────────────────────
 setting  value
