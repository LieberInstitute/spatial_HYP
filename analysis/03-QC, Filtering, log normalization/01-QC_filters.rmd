...
```{r}
hyp <- readRDS("processed-data/02_build_spe/spe_raw_w-V13M13-362.RDS")
...
plts <- vis_grid_gene(hyp4,"FEZF1",pdf_file = NULL,spatial = F,return_plots = T,auto_crop = T,point_size = 0.7)
