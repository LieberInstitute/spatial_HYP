...
```{r}
load("processed-data/02_build_spe/spe_raw_w-V13M13-362.Rdata")
hyp <- spe_raw
rm(spe_raw)
gc(full=T)
...
```{r}
ncol(hyp[,hyp$in_tissue==T&colData(hyp)$sum_umi>275&colData(hyp)$sum_gene>166&colData(hyp)$expr_chrM_ratio<0.5])/ncol(hyp[,hyp$in_tissue==T])
# 98.66% spots retained for now!
hyp2 <- hyp[,hyp$in_tissue==T&colData(hyp)$sum_umi>275&colData(hyp)$sum_gene>166&colData(hyp)$expr_chrM_ratio<0.5]
...
### apply rotations/mirrors to have all samples oriented medial=left, ventral=bottom
V12D05-348_C1: 90 CW
V12D05-348_D1: no ∆
V12D05-350_C1: 90 CW
V12D05-350_D1: no ∆
...
hyp4 <- cbind(hyp3,tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7)
...
plts <- vis_grid_gene(hyp4,"FEZF1",pdf_file = NULL,spatial = T,return_plots = T,auto_crop = T,point_size = 0.7,alpha=0.3,image_id = "hires")
do.call("grid.arrange",plts)
dev.off()
```

```{r}
saveRDS(hyp4,"data/03-QC_filters/hypN9_umi275_gene166_chrm50_lognorm_111723.RDS")
...
other attached packages:
 [1] colorout_1.3-0              spatialLIBD_1.14.1         
 [3] SpatialExperiment_1.12.0    SingleCellExperiment_1.24.0
 [5] SummarizedExperiment_1.32.0 Biobase_2.62.0             
 [7] GenomicRanges_1.54.1        MatrixGenerics_1.14.0      
 [9] matrixStats_1.2.0           gridExtra_2.3              
[11] ggplot2_3.4.4               Cairo_1.6-2                
[13] ggrastr_1.0.2               Biostrings_2.70.1          
[15] GenomeInfoDb_1.38.2         XVector_0.42.0             
[17] IRanges_2.36.0              S4Vectors_0.40.2           
[19] BiocGenerics_0.48.1         data.table_1.14.10         
[21] rlang_1.1.2                
...
[125] lazyeval_0.2.2                Matrix_1.6-4                 
...
[135] AnnotationHub_3.10.0          memoise_2.0.1                
[137] bslib_0.6.1                   scCoco_0.0.0.9000            
...
─ Packages ───────────────────────────────────────────────────────────────
 ...
 V BiocNeighbors            1.20.0     2023-12-19 [1] Bioconductor 3.18 (R 4.3.2) (on disk 1.20.1)
 ...
 V DBI                      1.1.3      2023-12-21 [1] CRAN (R 4.3.1) (on disk 1.2.0)
 ...
 V magick                   2.8.1      2023-12-20 [1] CRAN (R 4.3.1) (on disk 2.8.2)
