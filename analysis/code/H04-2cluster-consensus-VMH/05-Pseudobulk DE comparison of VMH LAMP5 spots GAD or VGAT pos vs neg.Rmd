...
write.table(deres,"analysis/data/spe_053123/H04-2cluster-consensus-VMH/05-Pseudobulk DE between VMH LAMP5 spots expressing or not expressing GADs or VGAT.txt",sep='\t',quote=F,row.names=F,col.names=T)
...
write.table(gseain,"analysis/data/spe_053123/H08-GSEA, GO etc/H04.05-VMHlamp_inhmarkers-vs-none-pseudobulkDE_log10Pval_ranked.rnk")
```
