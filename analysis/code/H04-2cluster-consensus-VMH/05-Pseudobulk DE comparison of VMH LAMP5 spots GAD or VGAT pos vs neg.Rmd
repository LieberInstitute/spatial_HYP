...
write.table(deres,"05-Pseudobulk DE between VMH LAMP5-NOinhmarker spots and those coexpr GADs or VGAT_posLFCisLAMPonly.txt",sep='\t',quote=F,row.names=F,col.names=T)
