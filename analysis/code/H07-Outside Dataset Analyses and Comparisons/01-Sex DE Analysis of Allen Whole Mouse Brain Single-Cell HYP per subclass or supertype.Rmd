...
dreamlet.sexde <- lapply(clustlevels,FUN=function(x){
    ...
    dif <- dreamlet::processAssays(proc,min.cells = 10,min.count = 10,min.samples = 4,min.prop = 0.4,normalize.method = "TMM",useCountsWeights = T,BPPARAM = sbp,formula = ~donor_sex)
