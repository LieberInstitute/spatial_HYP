...
dl.rf.res <- dreamlet::topTable(dl.ref,coef="SexM",number=Inf,adjust.method ="BH")

dl.rf.res <- as.data.table(dl.ref.res,keep.rownames=T)

saveRDS(dl.rf.res,"analysis/data/spe_053123/H07-Outside Dataset Analyses and Comparisons/spatialHYP_dreamletSexDE_brnum-as-random-effect-inDEmodel.RDS")
