...
```{r}
nnsvgs <- fread("analysis/data/01-feature_selection/meangeneranks_nnSVG_samplewise_n3s0.5.txt")
...
saveRDS(pcas,"analysis/data/H01-feature_selection/SPEs_sampleBlock-hvgs-10or20pctile_nnsvg10or20pctile_Harmony-PCA-UMAP.RDS")
```
