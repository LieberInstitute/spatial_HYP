---
title: "01-Pseudobulk Sex DE on ARC clusters individually and combined"
...
ARC clusters= #8, #13. Also run DE with the two joined.
```{r}
## iterate over individual clusters and combination.
clids <- list(8,13,c(8,13))
clnames <- c("8","13","both")
...
saveRDS(arc.reses,"analysis/data/spe_053123/H05-bspace15-nnsvg10_ARC_clusters/ARC_pseudobulk_sexDE_noSpRep-adjs_V12D07075B1-cropped.RDS")
```
...
### oh shiiiiiiiit letttt's fuckin go plot some genes
```
