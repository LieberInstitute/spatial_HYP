...
d.pltdat <- tmp[,.(spdomain,brnum,Sex,PC1,PC2,PC3)]
rm(pbpca,tmp)
####
...
tmp <- merge.data.table(tmp,unique(dref),by="sample_id")
dlPCA.pltdat <- tmp[,.(spdomain,brnum,Sex,PC1,PC2,PC3)]
rm(tmp)
...
dlrPCA.pltdat <- tmp[,.(spdomain,brnum,Sex,PC1,PC2,PC3)]
rm(tmp,dref)
gc(full=T)
```
...
Plots: # baseline pca
```{r}
png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pca_lognorm_allgenes.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC2,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc1-3_lognorm_allgenes.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc2-3_lognorm_allgenes.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC2,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pca_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC2,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc1-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc2-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC2,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pca_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC2,shape=Sex,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc1-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(d.pltdat,aes(x=PC1,y=PC3,col=brnum,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01a-PCAs from aggregatetopseudobulk/pb_pc2-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
...
Plots: # dlpca pca
```{r}
png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pca_lognorm_allgenes.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC2,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc1-3_lognorm_allgenes.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc2-3_lognorm_allgenes.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC2,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pca_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC2,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc1-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc2-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC2,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pca_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC2,shape=Sex,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc1-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(dlPCA.pltdat,aes(x=PC1,y=PC3,col=brnum,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01b-PCAs from vanilla dreamlet modeled pseudobulk/pb_pc2-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
...
Plots # dlrpca
```{r}
png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pca_lognorm_allgenes.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC2,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc1-3_lognorm_allgenes.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc2-3_lognorm_allgenes.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC2,y=PC3,col=spdomain,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pca_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC2,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc1-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc2-3_lognorm_allgenes_donor.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC2,y=PC3,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pca_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC2,shape=Sex,col=brnum))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc1-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
ggplot(dlrPCA.pltdat,aes(x=PC1,y=PC3,col=brnum,shape=Sex))+
    geom_point(size=3)
dev.off()

png("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/01c-PCAs from donor randomeffect dreamlet modeled pbulk/pb_pc2-3_lognorm_allgenes_donor-sex.png",width=900,height=800)
