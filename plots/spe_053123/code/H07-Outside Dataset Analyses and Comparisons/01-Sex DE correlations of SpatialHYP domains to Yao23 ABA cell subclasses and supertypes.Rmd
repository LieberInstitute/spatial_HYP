...
pdf("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/spHYP k15 domain correls to Yao23 ABA subclasses w spHYP analyzed w randomfx of donor or without.pdf",height=12,width=20)
do.call("grid.arrange",c(reslist[c(1,3)],ncol=2))
dev.off()

pdf("plots/spe_053123/H07-Outside Dataset Analyses and Comparisons/spHYP k15 domain correls to Yao23 ABA supertypes w spHYP analyzed w randomfx of donor or without.pdf",height=30,width=20)
