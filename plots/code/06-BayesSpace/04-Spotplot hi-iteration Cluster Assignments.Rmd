---
title: "04-Cluster Assignment Spotplots-60k iter BayesSpace runs"
...
stopifnot(sum(colnames(hyp2)==hyp2$key)==ncol(hyp2))

bs_clusts <- list.files("data/06-BayesSpace/02-bayesspace60kiter_k15-20-31_out/",pattern=".txt",full.names = T)
```
...
for (i in c(1:length(bs_clusts))) {
    ...
    pdf(
        paste0(
            "plots/06-BayesSpace/04-Hi iter cluster spotplots/",
