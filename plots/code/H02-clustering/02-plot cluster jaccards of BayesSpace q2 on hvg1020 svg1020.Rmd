...
```{r}
### plots
pdf("plots/H02-clustering/02-bayesspace_q2_HVGorSVG_jaccards/hvg10_hvg20.pdf",width=7,height=7)
    pheatmap(jac_h1020,cluster_cols=F,cluster_rows=F)
    dev.off()
    
pdf("plots/H02-clustering/02-bayesspace_q2_HVGorSVG_jaccards/hvg10_svg10.pdf",width=7,height=7)
    pheatmap(jac_h10s10,cluster_cols=F,cluster_rows=F)
    dev.off()
    
pdf("plots/H02-clustering/02-bayesspace_q2_HVGorSVG_jaccards/hvg10_svg20.pdf",width=7,height=7)
    pheatmap(jac_h10s20,cluster_cols=F,cluster_rows=F)
    dev.off()
    
pdf("plots/H02-clustering/02-bayesspace_q2_HVGorSVG_jaccards/hvg20_svg10.pdf",width=7,height=7)
    pheatmap(jac_h20s10,cluster_cols=F,cluster_rows=F)
    dev.off()
    
pdf("plots/H02-clustering/02-bayesspace_q2_HVGorSVG_jaccards/hvg20_svg20.pdf",width=7,height=7)
