...
tmp <- rotateObject(tmp,sample_id="V12Y31-080_A1",degrees=90)
...
pal <- Polychrome::createPalette(N = 15,seedcolors = c("#001859","#660053","#058a00","#009682","#4d4d4d","#bababa"))
pal[1:6] <- c("#001859","#660053","#058a00","#009682","#4d4d4d","#bababa")
...
pdf("plots/Manuscript/2A-Bayesspace k15 cluster spotplots.pdf",height=6,width=4)
...
cairo_pdf("plots/Manuscript/2B-Marker violins.pdf",height=6,width=4)

plotExpression(hypselect,features=c("LAMP5","AGRP","ANKRD34B","NPY","NR5A1","POMC","FEZF1","GAD1","SLC17A6","GAD2","ADCYAP1","GHRH","MBP","ERMN"),colour_by = "label",x="label",scales = "free_y",ncol = 2,point_fun = function(...) geom_quasirandom_rast(..., width=0.4, groupOnX=TRUE, bandwidth=1,size=0.2,alpha=0.8,dev="cairo",raster.dpi=600))+
...
Fig 2E: FEZF1 in V12D07-075_A1
```{r}
hypselect <- hyp2[,hyp2$sample_id=="V12D07-075_A1"]
# change rownames to gene symbols
rownames(hypselect) <- rowData(hypselect)$gene_name

pdf("plots/Manuscript/2E-FEZF1 in V12D05-075_A1.pdf",height=1.75,width=1.5)
