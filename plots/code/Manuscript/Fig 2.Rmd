...
vis_gene(hypselect, geneid = "GHRH", spatial = T, auto_crop = T, point_size = 0.525, alpha=0.8, pdf_file = NULL, return_plots = T, na_color = NA, viridis = FALSE) +
    ggtitle("*GHRH* (V12D05-<br>350_D1 - Female)") +
...
vis_gene(hypselect, geneid = "POMC", spatial = T, auto_crop = T, point_size = 0.525, alpha=0.8, pdf_file = NULL, return_plots = T, na_color = NA, viridis = FALSE) +
    ggtitle("*POMC* (V12D05-<br>348_C1 - Female)") +
    # counter vis_gene's plot margins to use the allocated area
    theme(
        axis.text = element_blank(),
        axis.text.x = element_blank(),
...
vis_gene(hypselect, geneid = "FEZF1", spatial = T, auto_crop = T, point_size = 0.525, alpha=0.8, pdf_file = NULL, return_plots = T, na_color = NA, viridis = FALSE) +
    ggtitle("*FEZF1* (V12D07-<br>075_D1 - Male)") +
    # counter vis_gene's plot margins to use the allocated area
    theme(
        axis.text = element_blank(),
        axis.text.x = element_blank(),
...
vis_gene(hypselect, geneid = "KISS1R", spatial = T, auto_crop = T, point_size = 0.525, alpha=0.8, pdf_file = NULL, return_plots = T, na_color = NA, viridis = FALSE) +
    ggtitle("*KISS1R* (V12Y31-<br>080_A1 - Male)") +
    # counter vis_gene's plot margins to use the allocated area
    theme(
        axis.text = element_blank(),
        axis.text.x = element_blank(),
...
other attached packages:
 [1] ggtext_0.1.2                ComplexHeatmap_2.18.0      
...
loaded via a namespace (and not attached):
 ...
 [55] ellipsis_0.3.2                iterators_1.0.14             
 ...
 [99] GlobalOptions_0.1.2           stringr_1.5.1                
...
[141] gridtext_0.1.5                memoise_2.0.1                
[143] bslib_0.6.1                   benchmarkmeData_1.0.4        
[145] bit_4.0.5                    
> sessioninfo::session_info()
─ Session info ───────────────────────────────────────────────────────────
 setting  value
