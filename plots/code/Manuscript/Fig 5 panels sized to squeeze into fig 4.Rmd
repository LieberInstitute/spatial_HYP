...
rm(tmp)
### tfs to plot
pltdat <- pltdat[tf %in% c("MYT1L","TCF20","PPARA","PPARG","ESR1","AR","LIN28B","ASH1L","VDR","STAT3")]
...
pltdat[pathway %in% grep(pathway,pattern="CREEDSID",value=T),source:="GEO TF\nPerturbations"]
...
seeds <- sample(c(1:656139287),40,replace=F)
### make plot
pdf("plots/Manuscript/5B as 4L-Sex DEG TF GSEA.pdf",height=4,width=5)
