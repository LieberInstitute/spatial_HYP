...
p+
    ...
    ggtitle("*ANKRD34B* (V12Y31-<br>080_A1 - Male)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
...
p+
    scale_color_manual(values=c("#5dd959","#8c63cf"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("*LAMP5* (V12D05-<br>350_D1 - Female)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
...
p+
    scale_color_manual(values=c("#5dd959","#8c63cf"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("*GABRE* (V12Y31-<br>080_A1 - Male)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
    theme(plot.title.position = "plot",plot.title = element_markdown(size=10,hjust=0.5),legend.text = element_text(size=8),legend.key.size = unit(0.125,"in"),legend.title=element_text(size=9,hjust=0.5),plot.margin = margin(-0.05,0.03,-0.05,0,unit = "in"))
dev.off()
...
p+
    scale_color_manual(values=c("#5dd959","#8c63cf"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("*CYP26A1* (V12D05-<br>350_D1 - Female)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
    theme(plot.title.position = "plot",plot.title = element_markdown(size=10,hjust=0.5),legend.text = element_text(size=8),legend.key.size = unit(0.125,"in"),legend.title=element_text(size=9,hjust=0.5),plot.margin = margin(-0.05,0.03,-0.05,0,unit = "in"))
dev.off()
...
p+
    ...
    scale_fill_gradient(low="white",high="black")+
    ggtitle("*NMU* (V12D05-<br>350_D1 - Female)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
    theme(plot.title.position = "plot",plot.title = element_markdown(size=10,hjust=0.5),legend.text = element_text(size=8),legend.key.size = unit(0.125,"in"),legend.title=element_text(size=9,hjust=0.5),plot.margin = margin(-0.05,0.03,-0.05,0,unit = "in"))
dev.off()
...
p+
    scale_color_manual(values=c("#5dd959","#8c63cf","#e949c1"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("*GAL* (V12Y31-<br>080_A1 - Male)")+
    guides(color="none")+
    labs(fill="log\ncounts")+
    theme(plot.title.position = "plot",plot.title = element_markdown(size=10,hjust=0.5),legend.text = element_text(size=8),legend.key.size = unit(0.125,"in"),legend.title=element_text(size=9,hjust=0.5),plot.margin = margin(-0.05,0.03,-0.05,0,unit = "in"))
dev.off()
...
pltdat[pathway=="DESCARTES_FETAL_ADRENAL_SYMPATHOBLASTS",pathway:="Fetal adrenal\nsympathoblasts"]
...
ggplot(pltdat,aes(y=pathway,x=-log10(padj)))+
    ...
    scale_color_manual(values=c("#5dd959","#8c63cf"),na.value = NA)+
    labs(col="Domain")+
    geom_vline(xintercept=-log10(0.05),linetype="dashed",linewidth=0.125)+
    ...
    theme(axis.text.y = element_text(size = 8,margin=margin(0,0,0,-0.15,"in")), axis.title.x = element_text(size = 9), axis.title.y=element_text(size=9,margin=margin(0,0,0,0.2,unit="in")),axis.text.x = element_text(size = 8), legend.text = element_text(size=8,hjust = 0.5), legend.title = element_text(size=9,hjust=0.5),legend.spacing.y = unit(0.125, "in"),plot.margin=margin(0.05,-0.075,0,-0.1,unit="in"),legend.margin = margin(0,0.075,0,-0.2,unit="in"),legend.box.background = element_blank(),legend.key = element_blank())
dev.off()
