...
```{r}
pgrM <- hyp2[,hyp2$sample_id=="V12D07-075_D1"]
...
pdf("plots/Manuscript/4F-PGR_ARCsexDE_M_malesamp.pdf",height=1.75,width=2)
p+
    scale_color_manual(values=c("purple","darkgreen"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("PGR (V12D07-\n075_D1 - Male)")+
...
### 
pgrF <- hyp2[,hyp2$sample_id=="V12D05-350_C1"]
...
pdf("plots/Manuscript/4G-PGR_ARCsexDE_M_femsamp.pdf",height=1.75,width=2)
p+
    scale_color_manual(values=c("purple","darkgreen"),na.value = NA)+
    scale_fill_gradient(low="white",high="black")+
    ggtitle("PGR (V12D05-\n350_C1 - Female)")+
