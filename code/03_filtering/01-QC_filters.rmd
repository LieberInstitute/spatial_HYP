...
```{r}
# from dcs04; in gitignore
load("data/spe_raw.Rdata")
hyp <- spe
rm(spe)
```
...
### i bet if and when we have cell counts, this correlates decently to it. but meanwhile, nothing too wild going on. most spots pick up a new gene for every 1-2 additional UMIs. a few are very low xscriptional complexity, e.g. lower RH of 075-D1.
dev.off()
```
...
# saveRDS(hyp2,"data/processing/hyp_umi600_gene450_chrm35_lognorm.RDS")
